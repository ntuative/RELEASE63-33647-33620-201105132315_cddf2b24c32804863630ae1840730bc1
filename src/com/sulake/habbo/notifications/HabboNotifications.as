package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1423:String = "pixelbalance";
      
      private static const const_1420:String = "badges";
      
      private static const const_1427:String = "selectbadge";
      
      private static const const_1422:String = "inventory";
      
      private static const const_1421:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1425:String = "friendlist";
      
      private static const const_1426:String = "pet_inventory";
      ...
      private var var_758:ParkBusDialogManager;
      
      private var var_2435:Boolean;
      
      private var var_939:ClubGiftNotification;
      
      private var var_937:ClubEndingNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_938);
         }
         var _loc6_:Map = this.var_938["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_938["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1162.push(_loc8_);
         return this.var_1162.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1162.splice(0,1);
      ...
      public function setQuestTrackerVisible(param1:Boolean) : void
      {
         if(this.var_360)
         {
            this.var_360.topMarginIncrease = !!param1 ? 135 : 0;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1431[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_376);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1431[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1431[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      {
         this.var_360 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_938["styles"],this.var_938["view"]);
         ...
         registerUpdateReceiver(this.var_360,1);
         registerUpdateReceiver(this,2);
         this.var_376.events.addEventListener(BadgeImageReadyEvent.const_108,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_376.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1184,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1184,null);
            }
         }
      }
      ...
      {
         this.addItem(param1,NotificationType.const_801,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_519.createAvatarImage(param2,AvatarScaleType.const_55);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1637,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.method_7 != RecyclerFinishedMessageEvent.const_1166)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1902,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_937 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
      ...
      {
         var _loc2_:* = null;
         if(this.var_360.isSpaceAvailable() && this.var_1162.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_360.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1426:
               if(this.var_13 != null && this.var_13.hasRoomSession)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_120);
               }
               break;
            case const_1421:
               break;
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_360.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_758 == null)
         {
            this.var_758 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_758 != null)
         {
            this.var_758.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1218,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1218,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_519.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_55);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2435)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_801,null);
            this.var_2435 = true;
      ...
      {
         if(param2.type == WindowEvent.const_174 || param2.type == WindowEvent.const_586)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_801,_loc6_);
      }
   }
}
