package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_1575:int = 78;
      
      private static const const_663:int = 4;
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_1302,this.var_1075,param1);
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         while(_loc2_ < this.var_195.length)
         {
            ...
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_620 + const_663;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_1589 = const_1575 + param1;
         var _loc2_:int = this.var_1589;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_195.length)
         {
            _loc4_ = this.var_195[_loc3_] as HabboNotificationItemView;
            _loc4_.reposition(_loc2_);
            _loc2_ = _loc4_.verticalPosition + HabboNotificationItemView.const_620 + const_663;
            _loc3_++;
         }
      }
   }
