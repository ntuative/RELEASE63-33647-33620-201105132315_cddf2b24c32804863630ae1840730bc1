package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1931:String = "badge_bg_001_png";
      
      private const const_2206:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         param13.events.addEventListener(BadgeImageReadyEvent.const_108,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2403 = this.var_62.getBadgeName(this.var_306);
         this.var_2400 = this.var_62.getBadgeDesc(this.var_306);
         this.var_2401 = this.var_62.getAchievementNameForFacebook(this.var_306,this.var_376.userName,this.var_376.realName,this.var_1306);
         this.var_2404 = this.var_62.getAchievementDescForFacebook(this.var_306,this.var_376.userName,this.var_376.realName,this.var_1306);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2402 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_62.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1948.toString());
         this.var_62.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1428.toString());
         this.var_62.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1428.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1777;
         var _loc17_:String = this.var_1777 == 0 ? "pixels" : "activitypoints";
         this.var_62.registerParameter(_loc16_,_loc17_,"" + this.var_2324);
         _loc15_.caption = this.var_62.getKey(_loc16_);
         this._window.findChildByName("achievement_info").caption = this._desc;
         this.setBadge(param13.getBadgeImage(param1),this.const_1931);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2206) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_62.registerParameter(param1,"badge_name",this.var_2403);
         this.var_62.registerParameter(param1,"badge_desc",this.var_2400);
         this.var_62.registerParameter(param1,"badge_name_fb",this.var_2401);
         this.var_62.registerParameter(param1,"badge_desc_fb",this.var_2404);
         this.var_62.registerParameter(param1,"level",this.var_1306.toString());
         this.var_62.registerParameter(param1,"name",this.var_376.userName);
         return this.var_62.registerParameter(param1,"realname",this.var_376.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_376.events.removeEventListener(BadgeImageReadyEvent.const_108,this.onBadgeImageReady);
            this.var_376 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1931);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_306,this._feedTitleFb,this.var_2402,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2405));
