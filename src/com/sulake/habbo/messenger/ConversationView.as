package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1398:int = 10;
      
      private static const const_1007:int = 100;
      
      private static const const_1399:int = 20;
       
      
      private var var_146:HabboMessenger;
      
      private var var_2363:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_146 = param1;
         this.var_1743 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_60 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2363 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_146.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1007 + const_1399)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_146.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1398;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_502 == null || _loc1_.id != this.var_502.id)
         {
            this.var_502 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_502.followingAllowed)
         {
            this.var_1743.enable();
         }
         else
         {
            this.var_1743.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_60.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_502.messages.length - const_1007);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_502.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_502.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_146.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_953 || param3.type == Message.const_757 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_502.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_146.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_146.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_146.send(new FollowFriendMessageComposer(this.var_502.id));
         this.var_146.send(new ConversionPointMessageComposer("Navigation","IM","go.im"));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_146.conversations.closeConversation();
