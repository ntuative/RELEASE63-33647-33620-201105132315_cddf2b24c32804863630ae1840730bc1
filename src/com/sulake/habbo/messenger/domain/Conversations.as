package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_881,0,this.var_473.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      {
         this._startIndex = Math.min(this._startIndex,this.var_148.length - this.var_473.getTabCount());
