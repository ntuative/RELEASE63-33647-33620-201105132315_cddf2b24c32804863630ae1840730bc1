package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      {
         if(this._windowManager && this._communication && this.var_187 && this._localization && this._friendList && this.var_1066 && this._soundManager)
         {
            unlock();
      ...
      public function playSendSound() : void
      {
         ...
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1134);
         }
      }
      
      public function isOpen() : Boolean
      {
         return this.var_239.isMessengerOpen();
      }
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_757,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1327,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
