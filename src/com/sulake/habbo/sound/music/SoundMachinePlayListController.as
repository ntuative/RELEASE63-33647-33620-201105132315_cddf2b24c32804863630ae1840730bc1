package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_230:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_230 = param2;
         this.var_720 = [];
         this.var_720.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_720.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_720)
         {
         ...
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_771,this.onSoundMachinePlayEvent);
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_852,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_83)
            {
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_771,this.onSoundMachinePlayEvent);
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_852,this.onSoundMachineStopEvent);
               this.var_83 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_462);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_230.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_462 = -1;
         this.var_683 = false;
         this.var_230.stop(HabboMusicPrioritiesEnum.const_129);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_230.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_230.playSong(param1,HabboMusicPrioritiesEnum.const_129,_loc3_,0,0,0))
         {
