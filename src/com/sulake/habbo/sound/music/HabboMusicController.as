package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1529:int = HabboMusicPrioritiesEnum.const_129;
      ...
      private var var_543:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_720.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_720.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_720)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_714,this.onJukeboxInit);
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_246,this.onJukeboxDispose);
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_721,this.onSoundMachineInit);
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_861,this.onSoundMachineDispose);
         ...
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_265)
         {
            this.var_326[_loc6_] = null;
            this.var_816[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1947)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_421)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_270)
            {
               ...
               {
                  _loc3_ = this.var_270.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_83)
            {
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_714,this.onJukeboxInit);
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_246,this.onJukeboxDispose);
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_721,this.onSoundMachineInit);
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_861,this.onSoundMachineDispose);
            }
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_270.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_265)
         {
      ...
      {
         if(this.var_659.getValue(param1) == null)
         {
            this.var_659.add(param1,param2);
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         while(_loc2_ < this.var_326.length)
         {
            if(this.var_326[_loc2_] != null)
            {
               ...
               _loc4_ = this.var_270.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_270.add(_loc6_.id,_loc10_);
               ...
               while(this.var_815.indexOf(_loc6_.id) != -1)
               {
                  this.var_815.splice(this.var_815.indexOf(_loc6_.id),1);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_265)
         {
            return false;
         }
         ...
         this.var_1947 = this.getSongRequestCountAtPriority(param1);
         this.var_1533 = param2;
         if(this._priorityPlaying <= const_1529)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2708 != param1.id || _loc3_ > this.var_2707 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2708 = param1.id;
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_543 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_83,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_543 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
