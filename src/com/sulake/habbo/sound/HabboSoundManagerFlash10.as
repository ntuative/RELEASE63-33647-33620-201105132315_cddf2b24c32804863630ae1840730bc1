package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1554:int = 60;
      
      private static const const_1555:int = 25165823;
      
      private static const const_1553:int = 16777215;
      ...
      private var var_1556:ByteArray;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_786,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1028.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               ...
               case HabboSoundTypesEnum.const_1124:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1787:
            ...
            this.var_1028.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_754;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_672.add(_loc4_,param1);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_187.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2778 = true;
            }
         }
      ...
      {
         if(this.var_187 == null || this._connection == null || this._roomEngine == null || this.var_230 != null)
         {
            return;
         }
         this.var_230 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_230.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1652,this.var_828));
         this.var_828 = -1;
         this.var_827 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_754 * 100)));
         }
      }
      ...
      {
         this.var_754 = param1;
         this.var_230.updateVolume(this.var_754);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_672.remove(param1);
            if(this.var_276.getValue(_loc2_) == null)
            {
               this.var_1556.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1556,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1556,_loc2_,TraxSample.const_1631,TraxSample.const_1792);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1277.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1554 && this.var_1277.length > 0)
            {
               _loc3_ = this.var_1277.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_672.length == 0 && this.var_828 != -1)
            {
               this.var_827.ready = true;
               _loc4_ = this.var_828;
               this.var_828 = -1;
               this.var_827 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_786,_loc4_));
               if(this.var_2778)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_827 == null && this.var_1278.length > 0)
         {
            ...
            if(_loc2_ != null && !_loc2_.disposed)
            {
               ...
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_786,_loc1_));
               }
               else
               {
                  this.var_827 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_230.samplesIdsInUse;
         var _loc4_:int = 0;
         ...
         if(_loc1_ > const_1555)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1553 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               ...
               this.var_230.samplesUnloaded(_loc7_);
            }
         }
      }
