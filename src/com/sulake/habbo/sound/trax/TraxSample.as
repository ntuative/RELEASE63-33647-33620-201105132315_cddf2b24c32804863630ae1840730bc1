package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1631:String = "sample_44khz";
      
      public static const const_1634:String = "sample_22khz";
      
      public static const const_1868:String = "sample_11khz";
      
      public static const const_1792:String = "sample_16bit";
      
      public static const const_1653:String = "sample_8bit";
      ...
      private var var_121:Vector.<int> = null;
      
      private var _id:int;
      
      private var var_165:int = 2;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_165 * this.var_77;
         var _loc7_:int = param1.length / 8;
         _loc7_ = int(_loc7_ / _loc6_) * _loc6_;
         this.var_121 = new Vector.<int>(_loc7_ / _loc6_,true);
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_165 == this.var_165 - 1)
            {
               this.var_121[int(_loc11_ / this.var_165)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_121.length * this.var_165 * this.var_77;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = 0;
         if(param1 == null || this.var_121 == null)
         {
            return param4;
         }
         var _loc5_:int = this.var_165 * this.var_77;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
         ...
         var _loc7_:int = 0;
         if(_loc6_ > this.var_121.length - param4)
         {
            _loc7_ = (_loc6_ - (this.var_121.length - param4)) * _loc5_;
            _loc6_ = this.var_121.length - param4;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_635.indexOf(param1) == -1)
         {
