package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      {
         this.var_253 = param2 as IHabboCommunicationManager;
         if(this.var_253 == null)
         {
            return;
         }
         this._connection = this.var_253.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2755 = this._config.getKey("interstitial.enabled","false") == "RoomWidgetStopEffectMessage";
         this.var_2754 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2752 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1969 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1269 == 0)
         {
            this.var_1269 = getTimer();
            return false;
         }
         if(this.var_1969 > 0 && this.var_1970 >= this.var_1969)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1269;
         if(_loc1_ > this.var_2754)
         {
            ++this.var_1970;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1551 = _loc2_.imageUrl;
         this.var_2753 = _loc2_.clickUrl;
         this.var_1269 = getTimer();
         if(this.var_1551 != "")
         {
            _loc3_ = this.var_1551;
            ...
            {
               this.var_237 = new Timer(this.var_2752,1);
            ...
            this.var_237.start();
            _loc4_ = new URLRequest(this.var_1551);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_488,0,0,param1.bitmapData,this.var_2753));
            this.var_1269 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1550 = _loc2_.imageUrl;
         this.var_1968 = _loc2_.clickUrl;
         if(this.var_1550 != "" && this.var_1968 != "")
         {
            _loc3_ = this.var_1550;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1550);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_567,0,0,_loc4_,_loc2_.assetName,this.var_1968,this.var_1267,this.var_1268));
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_663.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_663.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_663.remove(_loc2_.assetName);
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_663.remove(_loc2_.assetName);
