package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1205)
         {
            this._navigator.data.eventMod = true;
         }
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1638)
         {
      ...
      {
         if(this._navigator.configuration.getKey("roomenterad.habblet.enabled") == "RoomWidgetStopEffectMessage" && false)
         {
