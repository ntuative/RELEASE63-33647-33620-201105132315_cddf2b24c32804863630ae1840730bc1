package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_54 == null)
         {
            this.var_54 = IWindowContainer(this._navigator.getXmlWindow(this.var_1090));
            this.var_54.visible = false;
            this.var_54.setParamFlag(HabboWindowParam.const_42,true);
         ...
         this.var_54.x = _loc2_.x + this.var_2268 + param1.width;
