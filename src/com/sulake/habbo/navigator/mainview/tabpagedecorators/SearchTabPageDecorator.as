package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2076:TextSearchInputs;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_2076 == null)
         {
            ...
            this.var_2076 = new TextSearchInputs(this._navigator,false,_loc4_);
         ...
         {
            this.var_2076.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      {
         this._navigator.mainViewCtrl.startSearch(Tabs.const_194,Tabs.const_275,"-1",MainViewCtrl.const_733);
      }
