package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_137:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_137 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            this.prepareRoomCategories();
            this.var_137.addEventListener(WindowEvent.const_49,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_137 != null)
         {
            this.var_137.removeEventListener(WindowEvent.const_49,this.onFilterSelected);
            this.var_137.selection = 0;
            this.var_137.addEventListener(WindowEvent.const_49,this.onFilterSelected);
         }
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_137 == null ? 0 : int(this.var_137.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_206,Tabs.const_381);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_206,Tabs.const_813);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_206,Tabs.const_381,"" + _loc3_);
         }
         if(this.var_137)
         {
            this._navigator.trackNavigationDataPoint(this.var_137.enumerateSelection()[this.var_137.selection],"category.view");
         }
      }
      
      public function get filterCategory() : String
      {
         return !!this.var_137 ? this.var_137.enumerateSelection()[this.var_137.selection] : null;
      }
   }
}
