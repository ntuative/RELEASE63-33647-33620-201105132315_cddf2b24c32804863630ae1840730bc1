package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_528:RoomPopupCtrl;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_528 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_570 = IScrollbarWindow(this.var_177.findChildByName("scroller"));
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1701,true);
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_528.visible && this.var_2638)
         {
            return;
         }
         ...
         this.var_528.room = _loc4_;
         this.var_528.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1499.tags[0];
            this.var_1499.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2637 - _loc2_.stageX);
         this.var_2637 = _loc2_.stageX;
         this.var_2638 = _loc3_ > 2;
      }
   }
}
