package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_311:MainViewCtrl;
      ...
      private var var_2391:RoomThumbnailRenderer;
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_337,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_50)
         {
            ...
            {
               this.var_311.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_311.startSearch(Tabs.const_194,Tabs.const_411,param1);
         this.var_311.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_311.startSearch(Tabs.const_268,Tabs.const_254);
         this.var_471.getTab(Tabs.const_268).tabPageDecorator.tabSelected();
      }
