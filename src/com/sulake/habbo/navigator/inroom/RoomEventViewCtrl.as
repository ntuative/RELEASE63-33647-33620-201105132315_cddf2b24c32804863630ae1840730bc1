package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2014:ITextWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1572.visible = true;
         this.var_2014.visible = false;
         this.var_2016.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_1039.visible = true;
         this.var_2015.visible = false;
         ...
         this.var_2014.visible = true;
         this.var_2016.visible = false;
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_2015 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2819 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_2014 = ITextWindow(this.find("create_caption"));
            this.var_2016 = ITextWindow(this.find("edit_caption"));
            this.var_1571 = IButtonWindow(this.find("create_button"));
            this.var_1573 = IButtonWindow(this.find("edit_button"));
            this.var_2820 = IButtonWindow(this.find("cancel_button"));
            this.var_1572 = IButtonWindow(this.find("end_button"));
            this.var_1039 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1571,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1573,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1572,this.onEndButtonClick);
