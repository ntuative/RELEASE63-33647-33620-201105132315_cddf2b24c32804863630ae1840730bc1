package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2391 = new RoomThumbnailRenderer(param1);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1033.refreshTags(_loc1_,this.var_115.tags);
         ...
         this.var_2391.refreshThumbnail(_loc1_,this.var_115.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_194,Tabs.const_275,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
