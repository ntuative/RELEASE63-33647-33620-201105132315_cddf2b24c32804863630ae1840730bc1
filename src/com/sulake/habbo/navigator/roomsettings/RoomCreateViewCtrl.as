package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1106:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_583 = new Timer(100);
         this.var_583.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_583)
         {
            this.var_583.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_583.reset();
            this.var_583 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1106.view.findChildByName("select_arrow"));
      ...
      private function prepare() : void
      {
         ...
         this.var_1105 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_177.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function refresh() : void
      {
         ...
         this.var_1105.input.textBackgroundColor = 4294967295;
         this.var_1106 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      {
         return Boolean(this.var_1105.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1105.getText();
         var _loc3_:String = "model_" + this.var_1106.name;
