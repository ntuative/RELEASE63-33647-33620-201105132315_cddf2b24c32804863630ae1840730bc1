package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      {
         if(param1 != this.var_355 || this.var_1145 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1145 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1617)
         {
            this.var_750.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1657)
         {
            this.var_750.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1665)
         {
            this.var_1146.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1825)
         {
            this.var_918.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_750.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_327,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_504,this.onDoorModePasswordUnselect);
         ...
         this.var_750 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1146 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         ...
         this.var_1150 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1148 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1144 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1149 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_749 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1751 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_914 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_916 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2365 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1147 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1151 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1750 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1415 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_250 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1750.visible = this.var_1417;
         if(this.var_748)
         {
         ...
         else
         {
            ...
            this.var_1415.visible = true;
            this.var_2365.visible = this.var_1417;
            this.var_1147.height = Util.getLowestPoint(this.var_1147) + 4;
         }
         this.var_1416.text = !!this.var_748 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1147.name,this.var_1151.name,this.var_1415.name,this.var_1750.name],0,0);
         this._window.height = Util.getLowestPoint(this._window) + 4;
         this._window.visible = true;
      }
      
      private function disableWindow(param1:IWindow) : *
      {
         if(param1 != null)
         {
            param1.disable();
      ...
      private function enableWindow(param1:IWindow) : *
      {
         if(param1 != null)
         {
            param1.enable();
      ...
      private function populateForm() : void
      {
         ...
         this.var_750.setText(_loc1_.name);
         this.var_1146.setText(_loc1_.description);
         this.var_918.setText("");
         this.var_1150.setText("");
         ...
         if(!this.VIPFeaturesAllowed())
         {
            ...
            this.disableWindow(this.var_916);
            this.disableWindow(this.var_1751);
         }
         else
         {
            this.enableWindow(this.var_749);
            this.enableWindow(this.var_914);
            this.enableWindow(this.var_916);
            this.enableWindow(this.var_1751);
         }
         if(this.var_749)
         {
            if(_loc1_.hideWalls)
         ...
         if(this.var_914)
         {
            this.var_914.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_916)
         {
            this.var_916.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_750.getText();
         _loc2_.description = this.var_1146.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_609;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_119)
         {
            _loc8_ = this.var_918.getText();
            _loc9_ = this.var_1150.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_918.clearErrors();
               this.var_1150.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1148.isSelected;
         _loc2_.allowFoodConsume = this.var_1144.isSelected;
         _loc2_.allowWalkThrough = this.var_1149.isSelected;
         _loc2_.hideWalls = this.var_749.isSelected;
         _loc2_.wallThickness = this.var_914.selection - 2;
         _loc2_.floorThickness = this.var_916.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_917,_loc2_.tags);
         this.addTag(this.var_915,_loc2_.tags);
         this.clearErrors();
         this.var_1145 = _loc2_.roomId;
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_250.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_250.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_250.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_250.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_250.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_250.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_250.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_250);
         this.var_250.findChildByName("ruler").visible = true;
         ...
         if(this.var_73.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_250,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
