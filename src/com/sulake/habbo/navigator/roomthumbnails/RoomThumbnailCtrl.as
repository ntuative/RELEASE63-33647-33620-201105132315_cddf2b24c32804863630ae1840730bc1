package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1784 = IButtonWindow(this.find("bg_tab"));
         this.var_1785 = IButtonWindow(this.find("top_tab"));
         this.var_1786 = IButtonWindow(this.find("obj_tab"));
         this.var_2436 = IWindowContainer(this.find("tile_grid"));
         this.var_2437 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1784,this.onBgTabButton);
         Util.setProcDirectly(this.var_1785,this.onTopTabButton);
         Util.setProcDirectly(this.var_1786,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1784,this.var_68.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_1785,this.var_68.mode != ThumbnailEditorModel.const_62);
         this.setEnabled(this.var_1786,this.var_68.mode != ThumbnailEditorModel.const_36);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2437;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2436;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_602)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_529,HabboWindowStyle.const_47,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_337,HabboWindowStyle.const_47,HabboWindowParam.const_64,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
