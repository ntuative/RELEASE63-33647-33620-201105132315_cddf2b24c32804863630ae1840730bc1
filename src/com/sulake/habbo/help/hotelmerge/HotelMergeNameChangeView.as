package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_714)
         {
            this.var_714 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_714)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_713)
         {
            this.var_713 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_713)
            {
               return;
            }
