package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_850:FaqCategory;
      ...
      public function FaqIndex()
      {
         ...
         this.var_850 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_850.hasItem(param1))
         {
            this.var_850.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_850.hasItem(param1))
         {
            return this.var_850.getItem(param1);
         }
         var _loc2_:int = 0;
