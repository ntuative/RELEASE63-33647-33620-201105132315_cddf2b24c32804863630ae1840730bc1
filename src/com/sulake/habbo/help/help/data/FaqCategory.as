package com.sulake.habbo.help.help.data
{
   ...
   public class FaqCategory
   {
      ...
      public function storeItem(param1:int, param2:String, param3:String = null) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = new FaqItem(param1,param2,this.var_158.length,this);
      ...
      {
         return this.var_158.getValue(param1) != null;
      }
      ...
      {
         return this.var_158.length > 0 || this.hasUpdatedWithinHour();
      }
      
      public function setTimeStamp() : void
      {
         this.var_1703 = new Date();
      }
      ...
      public function getAgeSeconds() : Number
      {
         ...
         return (new Date().valueOf() - this.var_1703.valueOf()) / 1000;
      }
