package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2001:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105132305));
         this.var_127 = new Map();
         this.var_127.add(HabboHelpViewEnum.const_1780,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_189,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_607,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_345,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_292,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_412,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_802,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_285,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_127.add(HabboHelpViewEnum.const_1244,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_127.add(HabboHelpViewEnum.const_1275,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_951,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_553.length == 0 || param1 != this.var_393)
            {
               this.var_553.push(this.var_393);
            }
         }
         this.var_393 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_393);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_285:
               this.showUI(HabboHelpViewEnum.const_285);
               break;
            case CallForHelpResultEnum.const_1154:
               this.showUI(HabboHelpViewEnum.const_1275);
               break;
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_127.getValue(HabboHelpViewEnum.const_189) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_520));
      }
      ...
      {
         return this.var_127.getValue(this.var_393);
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2399;
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_553.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_393 == HabboHelpViewEnum.const_189)
         {
            return;
         }
         if(this.var_675.length < 2)
         {
            ...
            this.var_675.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_675.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_394.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_675[1],this.var_675[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_675[0],this.var_675[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_393 == HabboHelpViewEnum.const_189 || this.var_553.length == 0)
         {
            return;
         }
         if(this.var_394 == null)
         {
            ...
            this.var_394 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_394.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_394.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_394 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_394 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_394 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
