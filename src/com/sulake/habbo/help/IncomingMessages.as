   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_141)
            {
         ...
         this.var_23.tellUI(HabboHelpViewEnum.const_951);
      }
      ...
      {
         this.var_23.showUI(HabboHelpViewEnum.const_412);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this.var_23.tellUI(HabboHelpViewEnum.const_189);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this.var_23.tellUI(HabboHelpViewEnum.const_345,_loc6_);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this.var_23.tellUI(HabboHelpViewEnum.const_292,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_23.showUI(HabboHelpViewEnum.const_1110);
         this.var_23.tellUI(HabboHelpViewEnum.const_1110,_loc5_);
      }
