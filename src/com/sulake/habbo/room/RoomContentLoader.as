package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_748:String = "RCL_LOADER_READY";
      ...
      private static const const_676:String = "wall_place_holder";
      
      private static const const_677:String = "pet_place_holder";
      ...
      private static const const_1089:String = "selection_arrow";
      ...
      private var var_1586:IEventDispatcher = null;
      ...
      private var var_1050:Map = null;
      
      private var var_214:PublicRoomData = null;
      
      private var var_1587:Map = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2837 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2840 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2838 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2836 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_557.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_557.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_844.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
            ...
            else if(_loc2_.type == "i")
            {
               ...
               this.var_685.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_684.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_684.remove(_loc7_);
               this.var_684.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2839)
         {
            ...
            {
               this.var_1586.dispatchEvent(new Event(const_748));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_558 != null)
         {
            this.var_558.remove(param2);
            this.var_558.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_558 != null)
         {
            _loc2_ = this.var_558.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         return [const_460,const_676,const_677,const_675,TILE_CURSOR,const_1089];
      }
      ...
      {
         var _loc3_:String = this.var_685.getValue(param1) as String;
      ...
      {
         return this.var_1051.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1050[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_685.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_844.getValue(param1) != null)
         {
            return this.var_844.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_214 != null && this.var_214.hasWorldType(const_369 + param1))
         {
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_684.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1587.getValue(param1) != null)
         {
            this.var_214 = this.var_1587.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2837.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2840.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_576,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1050.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1587.add(param1,_loc4_);
         this.var_214 = _loc4_;
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_557.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = this.var_557.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_557.add(_loc5_,_loc4_);
      ...
      {
         if(this.getObjectCategory(const_369 + param1) == RoomObjectCategoryEnum.const_77)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_214.getWorldHeightScale(const_369 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_214 != null)
         {
            return this.var_214.getWorldScale(const_369 + param1);
         }
         return 32;
      }
