package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_419:int = 1000;
      
      public static const const_1737:int = 0;
       
      
      private var var_606:int = 0;
      
      private var var_1610:int = 360;
      
      private var var_859:DirectionData = null;
      
      private var var_283:Map;
      
      private var _colors:Map;
      
      private var var_1328:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_859 = new DirectionData(param1);
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_859,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc3_.copyValues(this.var_859);
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1201);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1108);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1610 / 2) % 360 / this.var_1610;
         ...
         {
            _loc6_ = int(this.var_283.getKey(_loc5_)) * this.var_1610;
