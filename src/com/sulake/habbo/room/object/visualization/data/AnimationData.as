package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class AnimationData
   {
      ...
      private var var_1600:Array = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_128 != null)
         {
            ...
            {
               _loc2_ = this.var_128.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         if(this.var_1600 != null && this.var_1600.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         this.var_128.add(param1,_loc6_);
      ...
      {
         var _loc4_:AnimationLayerData = this.var_128.getValue(param2) as AnimationLayerData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc6_:AnimationLayerData = this.var_128.getValue(param2) as AnimationLayerData;
         if(_loc6_ != null)
         {
