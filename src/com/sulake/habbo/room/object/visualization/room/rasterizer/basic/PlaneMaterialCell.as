package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_649:PlaneTexture;
      ...
      public function getHeight(param1:IVector3d) : int
      {
         ...
         if(this.var_649 != null)
         {
            _loc2_ = this.var_649.getBitmap(param1);
            if(_loc2_ != null)
            {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  ...
                  while(_loc6_ < _loc3_)
                  {
                     ...
                     _loc8_ = this.var_1010[_loc6_ % this.var_1010.length] as IGraphicAsset;
