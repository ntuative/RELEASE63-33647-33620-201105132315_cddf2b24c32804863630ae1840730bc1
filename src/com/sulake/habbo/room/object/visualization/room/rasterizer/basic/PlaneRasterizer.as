package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_637:String = "default";
      ...
      private function initializeTexturesAndMaterials() : void
      {
         ...
         if(_loc1_.length() > 0)
         {
            this.method_12(_loc1_[0],this.assetCollection);
         }
      ...
      private function method_12(param1:XML, param2:IGraphicAssetCollection) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc7_:* = null;
