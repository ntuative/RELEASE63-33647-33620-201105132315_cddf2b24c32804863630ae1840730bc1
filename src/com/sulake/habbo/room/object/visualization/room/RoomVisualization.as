package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1608:int = 16777215;
      
      public static const const_1827:int = 13421772;
      
      private static const const_1006:int = 16777215;
      
      private static const const_1003:int = 13421772;
      
      private static const const_1004:int = 10066329;
      
      private static const const_1005:int = 10066329;
      
      public static const const_1832:int = 16777215;
      
      public static const const_1911:int = 13421772;
      
      public static const const_1738:int = 10066329;
      ...
      private var var_747:Rectangle = null;
      
      private var var_501:RoomPlaneBitmapMaskParser = null;
      
      private var var_1477:String = null;
      
      private var _floorType:String = null;
      
      private var var_1476:String = null;
      ...
      private var var_2048:int = -1000;
      
      private const const_2202:int = 250;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_747 = super.boundingRectangle;
         }
         return new Rectangle(this.var_747.x,this.var_747.y,this.var_747.width,this.var_747.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         {
            this._planeParser.wallThicknessMultiplier = this.var_1413;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1231);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1326);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_379)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1889)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_71,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_379)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_2048 + this.const_2202 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_354.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1740)
                  {
                     ...
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2360 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2362 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1666)
         {
            this.var_1666 = param1.updateId;
            this.var_747 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1387 || _loc3_.y != this.var_2217 || _loc3_.z != this.var_2218 || param1.scale != this.var_1742))
            {
               this.var_1387 = _loc3_.x;
               this.var_2217 = _loc3_.y;
               this.var_2218 = _loc3_.z;
               this.var_1742 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_152 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1309);
            if(_loc3_ != this.var_1741)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1741 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_978));
            if(_loc4_ != this.var_1143)
            {
               this.var_1143 = _loc4_;
               this.var_2361 = this.var_1143 & 255;
               this.var_2360 = this.var_1143 >> 8 & 255;
               this.var_2362 = this.var_1143 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1302));
            if(_loc5_ != this.var_1740)
            {
               this.var_1740 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_152 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_219);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_209);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_192);
            ...
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_817));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_152 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1243);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1149);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1413))
            {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1142;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_71 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_251)
                              {
