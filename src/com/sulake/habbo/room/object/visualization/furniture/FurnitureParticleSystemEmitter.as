package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1855:String = "cone";
      
      public static const const_1703:String = "plane";
      
      public static const const_1830:String = "sphere";
      ...
      private var var_980:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_981 = 0;
         this.var_999 = false;
         this.init(0,0,0,this._direction,this.var_2590,this.var_980,this.var_2586,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1217.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_999 = true;
         if(this.var_981 < this.var_1487)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2589)
         {
            switch(this.var_2588)
            {
               case const_1855:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_980,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1217.length);
         return this.var_1217[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_981 < this.var_1487)
         {
            if(this.age % this.var_2587 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_981 < this.var_1487)
         {
            ...
            this.y = (2 - this.var_261) * this.y - (1 - this.var_261) * this.lastY + this.var_1867 * this.var_980 * this.var_980;
         ...
         for each(_loc2_ in this.var_368)
         {
            ...
            _loc2_.y = (2 - this.var_261) * _loc2_.y - (1 - this.var_261) * _loc2_.lastY + this.var_1867 * this.var_980 * this.var_980;
