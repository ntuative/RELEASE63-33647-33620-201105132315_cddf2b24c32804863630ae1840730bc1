   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != this.var_2219)
         {
            if(!param1)
            {
               this.var_293.assign(this.var_718);
               this.var_292.assign(this.var_719);
            }
            else
            {
               this.var_293.assign(this.var_718);
               this.var_293.mul(this.var_719.length / this.var_718.length);
               this.var_292.assign(this.var_719);
               this.var_292.mul(this.var_718.length / this.var_719.length);
            }
            this.var_1666 = -1;
            this.var_1387 = this.var_1387 - 1;
      ...
      private function needsNewTexture(param1:IRoomGeometry) : Boolean
      {
         ...
         if(this.var_271 > 0 && this._height > 0)
         {
            if(_loc3_ == null)
            {
               return true;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_97 == null && this.var_1100 != null || this.var_293 == null || this.var_292 == null || this._normal == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1666)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1387 || _loc4_.y != this.var_2217 || _loc4_.z != this.var_2218 || param1.scale != this.var_1742))
            {
               this.var_1387 = _loc4_.x;
               this.var_2217 = _loc4_.y;
               this.var_2218 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1100);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_155.z - _loc7_,this.var_113.z - _loc7_,this.var_85.z - _loc7_,this.var_112.z - _loc7_);
               this.var_2162 = _loc8_;
