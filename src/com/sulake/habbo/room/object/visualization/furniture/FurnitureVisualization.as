package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1914:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2289:Number = NaN;
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2204;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_478 != _loc3_.getUpdateID() || param1 != var_92 || param2 != this.var_2289)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(var_152 != _loc3_.getUpdateID())
         {
            this.var_2293 = _loc3_.getNumber(RoomObjectVariableEnum.const_264);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_354));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1132 = this.getAdClickUrl(_loc3_);
            if(this.var_1132 == null || this.var_1132.indexOf("http") != 0)
            {
               this.var_1132 = null;
            }
            this.var_2204 = this.var_1132 != null;
            this.var_2291 = _loc3_.getNumber(RoomObjectVariableEnum.const_974);
      ...
      {
         if(this.var_2292 != param2 || this.var_2288 != param1)
         {
            this.var_904 = [];
            this.var_905 = [];
            this.var_738 = [];
            ...
            this.var_2290 = this.getSize(param1);
      ...
      {
         this.var_606 = param1;
         this.var_1395 = this.var_606 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_583.length)
         {
            return "";
         }
         var _loc3_:String = this.var_904[param2];
         var _loc4_:Boolean = this.var_905[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2290;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1395)
            {
               _loc6_ = FurnitureVisualizationData.const_583[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_904[param2] = _loc3_;
            this.var_905[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_733[param3] != null && !this.var_1704)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2291 * (param1 / 2));
      }
