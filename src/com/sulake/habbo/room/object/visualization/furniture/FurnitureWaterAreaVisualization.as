package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      {
         if(this.var_2518 == param1 && this.var_2519 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1443)
            {
               this.var_1837 = _loc2_;
               this.var_2518 = param1;
               this.var_2519 = direction;
               return this.var_1837;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1192.indexOf(_loc2_) < 0)
            {
               this.var_1192.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1836 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_429.length)
         {
            if(this.var_429[_loc5_] == true)
            {
               this.var_1836 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_616[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_616[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_513 == 0 || this.var_615 == 0)
         {
            ...
            this.var_513 = _loc2_.getNumber(RoomObjectVariableEnum.const_330);
            this.var_615 = _loc2_.getNumber(RoomObjectVariableEnum.const_400);
         }
         this.var_429 = [];
         this.var_616 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_513 * 2 + this.var_615 * 2)
         {
            this.var_429.push(false);
            this.var_616.push(ShoreMaskCreatorUtility.const_83);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_69,getSize(param3),this.var_429,this.var_616,assetCollection);
      }
