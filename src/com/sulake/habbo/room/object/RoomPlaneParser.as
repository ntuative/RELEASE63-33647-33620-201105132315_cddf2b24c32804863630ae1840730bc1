package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_1081:Number = 0.25;
      
      private static const const_1245:Number = 0.25;
      ...
      private var var_1413:Number = 1.0;
      
      private var _floorThicknessMultiplier:Number = 1.0;
      
      private var var_902:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_670.push(_loc5_);
            _loc3_++;
         }
         this.var_271 = param1;
         this._height = param2;
         this.var_455 = this.var_271;
         this.var_457 = -1;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_271 && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_455 || param1 == this.var_457)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_458;
               ...
               if(param2 == this.var_458 || param2 == this.var_456)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_455;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < this.var_271)
            {
               this.var_670[_loc2_][_loc8_] = this.var_125[_loc2_][_loc8_];
               _loc8_++;
            }
            _loc2_++;
         }
         var _loc3_:Point = findEntranceTile(this.var_125);
         var _loc4_:int = 0;
         if(_loc3_ != null)
         {
         ...
         this.var_902 = getFloorHeight(this.var_125);
         if(!param1)
         {
      ...
      {
         var _loc12_:* = null;
         this.addPlane(RoomPlaneData.const_260,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_379,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1245 * this.var_1413;
         var _loc9_:Number = const_1081 * this._floorThicknessMultiplier;
         ...
         this.addPlane(RoomPlaneData.const_260,Vector3d.sum(param1,param3),param2,_loc11_,[_loc10_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_260,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_260,Vector3d.sum(param1,Vector3d.product(param3,-_loc9_ / param3.length)),Vector3d.product(param3,(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
            if(param7)
            {
               _loc12_ = Vector3d.product(param2,_loc8_ / param2.length);
               this.addPlane(RoomPlaneData.const_260,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc12_,-1)),_loc12_,_loc11_,[_loc10_,param2,param4]);
            }
         }
      }
      ...
      private function extractFloorPlane(param1:Array, param2:Boolean) : Boolean
      {
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_125[_loc3_] as Array;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_242,param1,param2,param3);
         var _loc13_:IVector3d = param1;
         var _loc14_:* = null;
         var _loc15_:* = null;
         if(_loc12_)
         {
            _loc16_ = const_1081 * this._floorThicknessMultiplier;
            if(param8 > 0)
            {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_242,_loc13_,new Vector3d(0,0,-_loc16_),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_242,_loc13_,new Vector3d(0,0,-_loc16_),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_242,_loc13_,new Vector3d(0,0,-_loc16_),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_242,_loc13_,new Vector3d(0,0,-_loc16_),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_271}" height="{this._height}" wallHeight="{this.var_1554}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc4_ = <tileRow/>;
            _loc5_ = this.var_670[_loc2_];
            _loc6_ = 0;
            while(_loc6_ < this.var_271)
            {
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1279;
         }
         var _loc2_:RoomPlaneData = this.var_133[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
