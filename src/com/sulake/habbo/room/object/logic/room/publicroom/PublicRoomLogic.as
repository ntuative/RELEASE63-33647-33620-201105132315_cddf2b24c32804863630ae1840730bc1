package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_199,RoomObjectRoomAdEvent.const_356,RoomObjectRoomAdEvent.const_343];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setNumber(RoomObjectVariableEnum.const_599,Number(false));
         this.var_759 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1233:
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_599,Number(true));
                  this.var_1452 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1128);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_599,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_531)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_742);
                  if(_loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_199,_loc5_,_loc6_,_loc7_));
