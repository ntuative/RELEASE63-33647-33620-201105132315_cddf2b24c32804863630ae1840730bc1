package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_579,RoomObjectMouseEvent.const_166];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1231,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_978,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_986,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1234)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1892;
            if(_loc2_ - this.var_1234 >= this.var_1894)
            {
            ...
            else
            {
               ...
               _loc10_ = this.var_1233 >> 16 & 255;
               _loc11_ = this.var_1233 >> 8 & 255;
               _loc12_ = this.var_1233 & 255;
               _loc13_ = (_loc2_ - this.var_1234) / this.var_1894;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_978,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_769:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_727:
               param2.setString(RoomObjectVariableEnum.const_219,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_732:
               param2.setString(RoomObjectVariableEnum.const_192,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_466:
               _loc5_ = "null";
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_919:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1309,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1220:
               param2.setNumber(RoomObjectVariableEnum.const_986,_loc3_);
               break;
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1081:
               param2.setNumber(RoomObjectVariableEnum.const_1243,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1245:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1302,int(param1.bgOnly));
         this.var_1507 = this._color;
         this.var_1893 = this.var_1892;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_562,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1835,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1910,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1717,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_562,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_260 || _loc12_ == RoomPlaneData.const_379)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
