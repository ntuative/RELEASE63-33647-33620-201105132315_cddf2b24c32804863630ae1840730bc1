package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_1953:int = 1;
      
      private static const const_1060:int = 10;
       
      
      private var var_1941:Vector3d = null;
      
      public function FurniturePushableLogic()
      {
         super();
         moveUpdateInterval = const_764;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.state > 0)
            {
               moveUpdateInterval = const_764 / this.getUpdateIntervalValue(_loc3_.state);
            }
            else
            {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1941.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1941).length == 0)
            {
