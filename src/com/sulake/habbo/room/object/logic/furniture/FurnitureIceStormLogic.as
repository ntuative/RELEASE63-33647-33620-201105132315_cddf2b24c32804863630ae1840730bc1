package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private var var_2642:Number = 0.0;
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2642 = param1.extra;
            this.var_1231 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1231 > 0 && param1 >= this.var_1231)
         {
            this.var_1231 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1889,String(this.var_1889),this.var_2642);
