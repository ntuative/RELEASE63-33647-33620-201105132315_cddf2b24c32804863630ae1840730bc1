package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_941,param1,param2,param3,param4));
         }
      }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomObjectMoveEvent.const_416:
               ...
               break;
            case RoomObjectMoveEvent.const_754:
            ...
            case RoomObjectFurnitureActionEvent.const_597:
               ...
               break;
            case RoomObjectRoomAdEvent.const_199:
            ...
            case RoomObjectRoomActionEvent.const_1635:
            case RoomObjectRoomActionEvent.const_631:
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            case RoomObjectMouseEvent.const_166:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_77)
         {
            ...
            if(_loc15_ != _loc10_ && _loc16_ != _loc10_)
            {
               ...
               if(_loc17_ != null)
               {
                  _loc17_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_463,param2,param3,-1,RoomObjectCategoryEnum.const_180));
               }
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_27 || _loc8_ == RoomObjectCategoryEnum.const_26)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_688,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_507:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_721,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_489:
            ...
            case RoomObjectFurnitureActionEvent.const_610:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_561:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_861,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_629:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_714,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_614:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1627,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_630:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1607,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_597:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_246,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_942);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_1239);
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_354,param2);
         }
      }
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1569,category) as IRoomObjectController;
      ...
      private function placeObject(param1:int, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc7_ == RoomObjectCategoryEnum.const_33 && _loc5_.typeId == RoomObjectTypeEnum.const_222)
               {
                  this._roomEngine.connection.send(new PlacePetMessageComposer(_loc6_,int(_loc10_),int(_loc11_)));
               }
               else if(_loc8_.getModelController().getString(RoomObjectVariableEnum.const_1310) != null)
               {
         ...
         if(this._roomEngine && this._roomEngine.events)
         {
            ...
            this._roomEngine.events.dispatchEvent(new RoomEngineObjectPlacedEvent(RoomEngineObjectEvent.const_144,param1,param2,_loc6_,_loc7_,_loc9_,_loc10_,_loc11_,_loc12_,_loc13_,_loc17_,param3,param4));
         }
      }
