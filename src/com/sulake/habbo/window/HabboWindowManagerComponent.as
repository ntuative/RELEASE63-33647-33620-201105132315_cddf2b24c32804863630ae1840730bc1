package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_461:uint = 3;
      
      private static const const_1587:uint = 1;
      ...
      private var var_1602:IEventDispatcher;
      
      private var var_1321:Boolean = false;
      
      private var var_2063:ProfilerOutput;
      
      private var var_1601:ProfilerAgentTask;
      
      private var var_1603:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1040 = new SkinContainer(_loc4_.content as XML,assets);
         this._windowRenderer = new WindowRenderer(this.var_1040);
         this.var_215 = new Array(const_461);
         ...
         this.var_259 = this.var_215[const_1587];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2063)
            {
               this.var_2063 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2063.profiler = _loc3_;
            this.var_1601 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1601);
            this.var_1603 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1603);
            this.var_1321 = true;
         }
      }
      ...
      {
         return this.var_259.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_259.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_1040.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_215[param1].getDesktopWindow().getChildAt(this.var_259.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1602.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_461 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1602.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_461)
         {
         ...
         this.var_1602.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1742,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1676,new Date().getTime().toString());
