package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1222;
         if(this.var_1222 < this.var_983.length)
         {
            _loc1_ = this.var_983[this.var_1222] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_983[this.var_1222] as Dictionary;
