package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_950));
         }
         this._widget = null;
         if(this._window)
         {
            this._window.removeEventListener(WindowEvent.const_115,this.onViewChange);
            this._window.removeEventListener(WindowEvent.const_323,this.onViewChange);
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._window.addEventListener(WindowEvent.const_115,this.onViewChange);
         this._window.addEventListener(WindowEvent.const_323,this.onViewChange);
