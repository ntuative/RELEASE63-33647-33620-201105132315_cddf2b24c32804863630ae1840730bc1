package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2221:int = 1000;
      ...
      {
         super();
         this.var_209 = new Timer(this.const_2221);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_190.isActive)
         {
            ...
            this.var_998.width = _loc2_ * this.var_295;
         }
         else
         {
            this.var_998.width = 0;
            this.var_209.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_797 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_797 == null)
            {
               return;
            }
         ...
         if(!this.var_190.isActive)
         {
            this.var_797.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_797.caption = "${widgets.memenu.effects.active.timeleft}";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.setTimeLeft();
         this.var_998 = this._window.findChildByName("loader_bar");
         if(this.var_998 != null)
         {
            this.var_295 = this.var_998.width;
            this.var_209.start();
            this.onUpdate();
         }
