      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1191);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_913);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1113));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_332);
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1259));
               this._widget.hide();
               break;
            case "settings":
            ...
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","false") == "RoomWidgetStopEffectMessage";
               if(false && _loc4_)
               {
