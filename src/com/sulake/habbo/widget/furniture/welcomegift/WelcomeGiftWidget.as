package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_678:String = "welcome_gift_email_unverified";
      
      private const const_1104:String = "welcome_gift_email_verified";
      
      private const const_1606:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1335)
         {
            this.setViewState(this.const_1104);
         }
         else
         {
            this.setViewState(this.const_678);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_678:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1081;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1081);
               break;
            ...
            case this.const_1606:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1081);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1613;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1606);
      }
      ...
      {
         this.setViewState(!!this.var_1335 ? this.const_1104 : this.const_678);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1612 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1612));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_619,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_696,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_619,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_696,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_619:
               this.var_1613 = param1.email;
               this.var_1335 = param1.isVerified;
               this.var_1081 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1613 = this.var_1612;
            this.setViewState(this.const_678);
         }
         else
         {
            if(param1.result == this.const_2241)
            {
               this.var_1081 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1612);
