package com.sulake.habbo.widget.furniture.trophy
{
   ...
   public class TrophyFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1363:Array = new Array("trophy_bg_gold","trophy_bg_silver","trophy_bg_bronze");
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTrophyDataUpdateEvent.const_778,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTrophyDataUpdateEvent.const_778,this.onObjectUpdate);
      }
      ...
      private function showInterface() : void
      {
         ...
         _loc8_ = assets.getAssetByName(const_1363[this._color]) as BitmapDataAsset;
