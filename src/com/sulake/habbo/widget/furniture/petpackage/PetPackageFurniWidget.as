package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_424,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_424,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomWidgetPetPackageUpdateEvent.const_532:
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_424:
      ...
      {
         var _loc2_:* = null;
         if(this.var_619 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_619.width) / 2,(_loc1_.height - this.var_619.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_619,this.var_619.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1194 || this.var_218 == -1)
         {
            return;
         }
         ...
         {
            this.var_1194 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_963,this.var_218,name);
