package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_2071) as IWindowContainer;
            ...
            _loc3_.width = this.var_691.width;
            _loc3_.height = this.var_691.height;
            this.var_562.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_691.width,this.var_691.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_691,this.var_691.rect,new Point(0,0));
            }
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_1074.width,this.var_1074.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_1074,this.var_1074.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_2071 = XML(_loc2_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_frame"));
         this.var_691 = BitmapData(_loc3_.content);
         ...
         this.var_1074 = BitmapData(_loc3_.content);
      }
