package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_657:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1416,const_1417,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_657 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1530 = _loc2_.light;
         if(this.var_450 != null)
         {
            this.var_450.setValue(this.var_1530);
         }
         this.var_538 = this.colors.indexOf(_loc2_.color);
         if(this.var_657 != null)
         {
            this.var_657.setSelectedColorIndex(this.var_538);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1531 = XML(_loc1_.content);
         return this.var_1531;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_657 != null)
         {
            this.var_657.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
