package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_999:String = "Boy";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_387,this.onUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_387,this.onUpdate);
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_387:
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this.var_2168 = param1.objectCategory;
         ...
         this._window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_79,HabboWindowStyle.const_47,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
         ...
         _loc4_ = this._window.findChildByName(const_999);
         if(_loc4_ != null)
         {
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_391,param1,this.var_218,this.var_2168,this._roomId,this._roomCategory,_loc5_);
