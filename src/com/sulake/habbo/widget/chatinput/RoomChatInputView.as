package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private const const_2197:int = 250;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1129 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2273 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2272 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_350 = new Timer(1000,1);
         this.var_350.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_421 = new Timer(10000,1);
         this.var_421.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_421.reset();
            this.var_421.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_421 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var _loc2_:int = this._widget.config.getKey("friendbar.enabled") == "RoomWidgetStopEffectMessage" ? 55 : 5;
         ...
         this.var_1700 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1701 = this._window.findChildByName("send_button_text");
         this.var_1393 = this._window.findChildByName("block_text");
         this.var_1701.caption = this.const_2198;
         ...
         this.var_25.addEventListener(WindowKeyboardEvent.const_315,this.keyUpHandler);
         this.var_25.addEventListener(WindowEvent.const_107,this.onInputChanged);
         ...
         this._window.addEventListener(WindowEvent.const_526,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1700.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - this.const_2197 - _loc3_;
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_25 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1129 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_25.text = "";
                  this.var_592 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_592.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_591);
