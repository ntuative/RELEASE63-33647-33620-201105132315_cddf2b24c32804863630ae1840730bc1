package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private var var_312:Timer = null;
      ...
      {
         return getTimer() - this.var_2517 > const_1442;
      }
      
      public function setLastPasteTime() : void
      {
         this.var_2517 = getTimer();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_922,this.onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_152,this.onUserInfo);
         param1.addEventListener(RoomWidgetFloodControlEvent.const_820,this.onFloodControl);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_922,this.onChatInputUpdate);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_152,this.onUserInfo);
         param1.removeEventListener(RoomWidgetFloodControlEvent.const_820,this.onFloodControl);
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1153:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1654:
         }
      }
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            this._visualization.updateBlockText(this.var_312.repeatCount - this.var_312.currentCount);
         }
      }
      ...
      public function onFloodControl(param1:RoomWidgetFloodControlEvent) : void
      {
         ...
         {
            this.var_312 = new Timer(1000,param1.seconds);
            this.var_312.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_312.addEventListener(TimerEvent.TIMER_COMPLETE,this.onReleaseTimerComplete);
         }
         this.var_312.start();
         if(this._visualization != null)
         {
