package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1563:int = 16;
      ...
      private static const const_1569:uint = 2085362;
      
      private static const const_1556:uint = 39616;
      
      private static const const_1559:uint = 10513106;
      
      private static const const_1561:uint = 8734654;
      
      private static const const_1565:uint = 9094430;
      
      private static const const_1564:uint = 6200576;
      
      private static const const_1560:String = "happiness";
      
      private static const const_1566:String = "experience";
      
      private static const const_1562:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_47 == null || this.var_98 == null)
         {
            return;
         }
         this.var_98.width = this.var_98.width;
         this.var_98.visible = this.var_98.width > 0;
         this.var_53.height = this.var_53.scrollableRegion.height;
         this.var_47.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_47.width,this.var_98.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_47.width < this.var_98.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1560,param1.nutrition,param1.nutritionMax,const_1556,const_1569);
         this.updateStateElement(const_1566,param1.experience,param1.experienceMax,const_1561,const_1559);
         this.updateStateElement(const_1562,param1.energy,param1.energyMax,const_1564,const_1565);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1568,const_1563,false);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_512) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc4_:* = [];
         this.var_98.groupChildrenWithTag("CMD_BUTTON",_loc4_,true);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_213 && this.var_213.getPetId() == this.var_512)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_423,this._widget.petData.ownerId);
      ...
      {
         var _loc5_:* = null;
         var _loc1_:int = const_1567;
         this.var_98.width = _loc1_;
         var _loc2_:* = [];
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1084 + const_1085;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1085;
            }
         }
         this.var_98.height = _loc4_ + const_1084;
         this.updateWindow();
      }
   }
}
