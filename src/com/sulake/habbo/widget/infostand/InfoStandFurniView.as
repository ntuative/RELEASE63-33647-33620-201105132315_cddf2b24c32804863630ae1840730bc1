package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc5_.name)
         {
            ...
            case "save_branding_configuration":
               ...
               break;
            case "RoomWidgetOpenPetPackageMessage":
               _loc3_ = "null";
         }
         if(_loc3_ != null)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_859 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_577 && param1.isRoomOwner)
         {
         ...
         this.showButton("RoomWidgetOpenPetPackageMessage",_loc6_);
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1137.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
