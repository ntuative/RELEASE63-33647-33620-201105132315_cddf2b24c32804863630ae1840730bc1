package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_2894:Boolean = true;
      
      private const const_1101:int = 5;
      
      private const const_1968:int = 7829367;
      
      private const const_1967:int = 16777215;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_2894 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1101;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1968;
            }
            else
            {
               _loc3_.textColor = this.const_1967;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_1101,this.const_2239);
         if(param2)
         {
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2893 > this.const_2240 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2893 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1968;
         }
      }
