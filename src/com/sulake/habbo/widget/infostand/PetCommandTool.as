package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private static const const_1441:Point = new Point(100,30);
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_363 = new Timer(this.const_2214);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1191.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_512);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1191.getValue(this.var_512) as CommandConfiguration;
      ...
      {
         this.var_1191.remove(param1);
         this.var_1191.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_745,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_40.position = const_1441;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_428 == null)
         {
            ...
            this.var_428 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_428 == null)
            {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_375,this.var_512));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_632,this.var_512,this.var_1834 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_632,this.var_512,this.var_1834 + " " + _loc5_);
