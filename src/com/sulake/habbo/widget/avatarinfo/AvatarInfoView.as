package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1430:int = 25;
      ...
      protected var var_1344:Boolean;
      
      protected var var_2137:FixedSizeStack;
      
      protected var var_2135:int = -1000000;
      
      public function AvatarInfoView(param1:AvatarInfoWidget)
      {
         this.var_2137 = new FixedSizeStack(const_1430);
         super();
         this._widget = param1;
      }
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1618 = param5;
         param1.var_2608 = param4;
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_708));
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1344)
         {
            ...
            if(this.var_1618 == RoomObjectTypeEnum.const_141 || this.var_1618 == RoomObjectTypeEnum.const_575)
            {
            ...
            this.var_2137.addValue(_loc5_);
            _loc6_ = this.var_2137.getMax();
            if(_loc6_ < this.var_2135 - const_1023)
            {
               _loc6_ = this.var_2135 - const_1023;
            }
