package com.sulake.habbo.widget.notification
{
   ...
   public class UserNotificationView implements IDisposable
   {
      ...
      protected static const const_1920:String = "button_ok";
      
      protected static const const_1921:String = "text_title";
      
      protected static const DESCRIPTION_NAME:String = "text_description";
      
      protected static const const_2194:String = "widget_notification_frame";
      ...
      public function showNotification(param1:String, param2:String) : Boolean
      {
         ...
         dialog.findChildByName(const_1921).caption = title;
         dialog.findChildByName(DESCRIPTION_NAME).caption = description;
         dialog.center();
         dialog.findChildByName(const_1920).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,function(param1:WindowMouseEvent):void
         {
