package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_550:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_550.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_550 = null;
         }
         if(this.var_46 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_550 == null)
         {
            ...
            this.var_550.addChild(new Bitmap(this.var_46));
            this.var_550.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_550.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_46;
            }
         }
         _loc2_.setDisplayObject(this.var_550);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1132 != "")
         {
            HabboWebTools.openWebPage(this.var_1132);
         }
      }
   }
}
