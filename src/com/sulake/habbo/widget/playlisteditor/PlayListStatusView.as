package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_719:String = "PLSV_ADD_SONGS";
      
      public static const const_1232:String = "PLSV_START_PLAYBACK";
      ...
      {
         if(this.var_45 != const_545)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_454[this.var_45];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_454[const_719];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_454.add(const_545,_loc1_);
