package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_884:String = "MISV_BUY_MORE";
      
      public static const const_844:String = "MISV_PREVIEW_PLAYING";
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1761.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_844,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_884,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_454.add(const_844,_loc1_);
            this.var_1762 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1761 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_512));
         ...
         if(_loc1_ != null)
         {
            this.var_454.add(const_884,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_481));
         }
      }
