package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridItem
   {
      ...
      private static const const_1418:uint = 14612159;
      ...
      private var var_2733:IContainerButtonWindow = null;
      ...
      private function createWindow() : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_2733 = _loc2_.getChildByName("button_to_playlist") as IContainerButtonWindow;
         }
         ...
         this.playButtonState = const_625;
      }
