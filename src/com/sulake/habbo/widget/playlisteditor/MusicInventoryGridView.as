package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         this._items = new Map();
         var _loc4_:int = this.var_230.getSongDiskInventorySize();
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = this.var_230.getSongDiskInventoryDiskId(_loc5_);
            _loc8_ = this.var_230.getSongDiskInventorySongId(_loc5_);
            _loc9_ = this.var_230.getSongInfo(_loc8_);
            _loc10_ = null;
            _loc11_ = null;
            if(_loc9_ != null)
            {
            ...
            this.var_585.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_100.playButtonState = MusicInventoryGridItem.const_1175;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_100 != null)
         {
            this.var_100.playButtonState = MusicInventoryGridItem.const_625;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_165;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_100.playButtonState == MusicInventoryGridItem.const_625)
               {
                  this.var_100.playButtonState = MusicInventoryGridItem.const_1170;
            ...
            {
               _loc4_ = this.var_585.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
