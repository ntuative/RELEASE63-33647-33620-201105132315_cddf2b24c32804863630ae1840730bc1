package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_186.state = RoomChatHistoryPulldown.const_239;
         ...
         this.var_50 = param2.createWindow("chatscroller","",HabboWindowType.const_1160,HabboWindowStyle.const_47,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_186.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_239);
      }
      ...
      {
         return !!this.var_441 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_186.state == RoomChatHistoryPulldown.const_392 || this.var_186.state == RoomChatHistoryPulldown.const_505;
      }
      ...
      {
         if(!this.var_441 && !this.var_1783)
         {
            this.var_441 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_186.state = RoomChatHistoryPulldown.const_392;
            if(this._widget != null)
            {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_442 > 0 && param2)
         {
            if(this.var_1860)
            {
               if(Math.abs(param1 - this.var_442) <= const_1297)
               {
                  return;
               }
               this.var_1860 = false;
            ...
            if(this.var_441)
            {
               ...
               _loc5_ = (param1 - this.var_442) / this.var_50.height;
               _loc3_ = this.var_633 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_442;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_50.scrollV < 1 - const_1462 / this.var_50.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1861)
               {
