package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2704:FriendListLookAndFeel;
      
      private var var_471:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1944:OpenedToWebPopup;
      
      private var var_2370:int;
      
      var var_105:FriendCategories;
      
      private var _friendRequests:FriendRequests;
      
      private var var_1945:AvatarSearchResults;
      ...
      {
         this.var_2704 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_105 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1945 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_656.stop();
            this.var_656.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_656 = null;
         }
         ...
         if(this.var_146)
         {
            this.var_146.release(new IIDHabboMessenger());
            this.var_146 = null;
         }
         if(this.var_187)
         {
         ...
         if(this.var_814)
         {
            this.var_814.release(new IIDSessionDataManager());
            this.var_814 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1944 = new OpenedToWebPopup(this);
         }
         this.var_1944.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_105.findFriend(param1);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_431);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_105.getFriendCount(param1,param2);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_337,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1066.createAvatarImage(param1,AvatarScaleType.const_93,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "RoomWidgetStopEffectMessage";
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_146 = param2 as IHabboMessenger;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_105.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_105.addCategory(new FriendCategory(FriendCategory.const_1132,this.getText("friendlist.friends")));
         this.var_105.addCategory(new FriendCategory(FriendCategory.const_371,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_105.addFriend(new Friend(_loc4_));
         }
         this.var_471 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_656)
         {
            this.var_656 = new Timer(120000);
            this.var_656.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_656.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         if(this.var_105.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_105.findCategory(FriendCategory.const_371);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_471.findTab(FriendListTab.const_101).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_471.findTab(FriendListTab.const_101);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1945.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_105.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_105.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_471.findTab(FriendListTab.const_101);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_814 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_814.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_814.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_43))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(disposed || this.var_105 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_105.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
