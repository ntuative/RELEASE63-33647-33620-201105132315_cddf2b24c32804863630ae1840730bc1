package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1441:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2090:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2090 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1441;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1042 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_255 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_2090.prepare(this.var_1042);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1156,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1107,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_853,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_876,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_853,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_876,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1614 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1614.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2092 == -1 ? 0 : int(this.var_17.height - this.var_2092);
         var _loc4_:int = this.var_2089 == -1 ? 0 : int(this.var_17.width - this.var_2089);
      ...
      private function method_15() : void
      {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1143,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_853,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1156,false);
         ...
         this.var_2092 = this.var_17.height;
         this.var_2089 = this.var_17.width;
