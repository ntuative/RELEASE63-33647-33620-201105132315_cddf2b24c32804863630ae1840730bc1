   ...
   public class HabboGroupInfoManager
   {
      ...
      private function onHabboGroupBadges(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.length)
         {
            ...
            if(this.var_281.getValue(_loc4_) != null)
            {
               this.var_281.remove(_loc4_);
            }
            this.var_281.add(_loc4_,_loc3_.getWithIndex(_loc6_));
            _loc6_++;
         }
      }
      ...
      private function onGroupDetails(param1:IMessageEvent) : void
      {
         ...
         _loc3_.badgeId = this.var_281.getValue(_loc2_.groupId);
      ...
      {
         return this.var_281.getValue(param1);
      }
