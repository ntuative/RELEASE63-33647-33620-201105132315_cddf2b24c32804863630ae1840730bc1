package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1931)
         {
            this.gotoRoom(this.var_2694,this.var_2695,this.var_1930);
            this.var_1931 = false;
            this.var_1930 = "";
         }
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1179:
                  break;
               case RoomSessionHandler.const_1315:
                  break;
               case RoomSessionHandler.const_725:
