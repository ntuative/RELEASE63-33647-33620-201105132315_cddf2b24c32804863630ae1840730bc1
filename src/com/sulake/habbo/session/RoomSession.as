package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2215:int = 2500;
      ...
      private var var_1216:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1216 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1216.connection = param1;
         }
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1486));
         this.var_1485.add(this.var_1486,getTimer());
         ++this.var_1486;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1485.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2215)
            {
      ...
      {
         return this.var_1216 as IUserDataManager;
      }
