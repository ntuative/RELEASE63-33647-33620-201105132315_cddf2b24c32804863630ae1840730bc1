package com.sulake.habbo.communication.encryption
{
   ...
   public class RC4_R27 extends RC4 implements IEncryption
   {
      ...
      private static const const_994:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
       
      
      private var var_1729:IEncryption;
      
      private var var_2344:PseudoRandom;
      ...
      override public function encipher(param1:ByteArray, param2:Boolean = false) : ByteArray
      {
         ...
         if(this.var_1729 != null)
         {
            ...
            _loc6_ = this.var_2344.nextInt() % 5;
            ...
            _loc5_ = this.var_1729.encipher(_loc7_,true);
