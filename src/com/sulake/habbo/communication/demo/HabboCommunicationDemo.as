package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2714:PseudoRandom;
      ...
      private const const_1957:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_660 = param1;
            this.var_57.initConnection(HabboConnectionType.const_284);
         }
      }
      ...
      {
         if(this.var_57 && this.var_143 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_660 = this.var_143.getKey("sso.ticket",null);
         this.var_1953 = this.var_143.getKey("flash.client.url","");
         this.var_2712 = this.var_143.getKey("external.variables.txt","");
         if(this.var_235 == null)
         {
            this.var_235 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_523,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1642);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_57.mode = HabboConnectionType.const_1323;
            }
         }
         this.var_57.initConnection(HabboConnectionType.const_284);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2714 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_57.mode)
         {
            case HabboConnectionType.const_97:
               ...
               this.var_235.loadBannerImage(_loc7_ + "?token=" + this.var_1537,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1323:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1672:
               this.var_1017 = this.generateRandomHexString(30);
               this.var_544 = new DiffieHellman(new BigInteger(this.var_143.getKey("connection.development.prime"),16),new BigInteger(this.var_143.getKey("connection.development.generator"),16));
               this.var_544.init(this.var_1017);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2714);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1953,this.var_2712));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1957,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2713)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1537);
