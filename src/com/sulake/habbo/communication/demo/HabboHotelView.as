package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_847.loadAssetFromFile("hotel_view_banner_" + this.var_1304,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_793));
            }
