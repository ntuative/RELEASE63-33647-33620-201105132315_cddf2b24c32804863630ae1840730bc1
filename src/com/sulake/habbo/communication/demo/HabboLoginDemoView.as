package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_523:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_170.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_151,HabboWindowStyle.const_47,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1957,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_170.habboConfiguration.getKey("use.sso","false") == "RoomWidgetStopEffectMessage")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1957,"/");
         ...
         {
            dispatchEvent(new Event(const_523));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_147.removeEventListener(SSOTicket.const_380,this.onParsedTicketSuccess);
            this.var_147.removeEventListener(SSOTicket.const_342,this.onParsedTicketFailure);
            this.var_147 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_147.addEventListener(SSOTicket.const_380,this.onParsedTicketSuccess);
         this.var_147.addEventListener(SSOTicket.const_342,this.onParsedTicketFailure);
      }
