package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1702:uint = 2;
       
      
      private var var_1555:IProtocolEncoder;
      
      private var var_1276:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1555 = new WedgieEncoder();
         this.var_1276 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1866)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1276.getID(_loc4_);
