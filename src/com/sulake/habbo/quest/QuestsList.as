package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1367:int = 30;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_725 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_725.toggle();
         this.var_1684 = false;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_60.spacing = const_1364;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1365;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1367;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1684 && !this.var_1683)
            {
               this.var_1684 = false;
