package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private var var_1171:QuestController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1171 = new QuestController(this);
         ...
         registerUpdateReceiver(this,const_1429);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_376.events.removeEventListener(BadgeImageReadyEvent.const_108,this.var_945.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_376.events.addEventListener(BadgeImageReadyEvent.const_108,this.var_945.onBadgeImageReady);
      }
      ...
      {
         return this.var_1171.questTracker.isVisible();
      }
      ...
      {
         return this.var_187.getKey("questing.enabled","false") == "RoomWidgetStopEffectMessage";
      }
