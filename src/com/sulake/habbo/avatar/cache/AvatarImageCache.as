package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1930:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1567:IAvatarImage;
      ...
      private var var_2378:ByteArray;
      
      private var var_2380:ImageData;
      
      private var var_1053:PaletteMap;
      
      private var var_920:Array;
      
      private var var_919:Point;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_751 == GeometryType.const_1123 && param1 == GeometryType.const_1214 || this.var_751 == GeometryType.const_1214 && param1 == GeometryType.const_1123)
         {
            this.var_751 = param1;
            this.var_89 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_356.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_908)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1567.getFigure(),_loc5_,this.var_751,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_430 == null)
         {
            ...
            this.var_430 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_356);
            if(this.var_430 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_89)
         {
            this.var_89 = this._structure.getCanvas(this._scale,this.var_751);
            if(!this.var_89)
            {
               return null;
            }
            this.var_2379 = new Point(0,this.var_89.height - int(this.var_89.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1880[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_855 || _loc10_ == AvatarAction.const_438;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1419 = this.var_114.bodyPartId;
               this.var_182 = this.var_114.partType;
               this.var_1763 = this.var_114.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_114.flippedPartType != this.var_182)
                     {
                        this.var_182 = this.var_114.flippedPartType;
                     }
                  }
               }
               this.var_1418 = this._scale + "_" + this.var_114.action.assetPartDefinition + "_" + this.var_182 + "_" + this.var_1763 + "_" + _loc5_ + "_" + this._frame;
               this.var_425 = this._assets.getAssetByName(this.var_1418) as BitmapDataAsset;
               if(this.var_425 == null)
               {
                  this.var_1418 = this._scale + "_std_" + this.var_182 + "_" + this.var_1763 + "_" + _loc5_ + "_0";
                  this.var_425 = this._assets.getAssetByName(this.var_1418) as BitmapDataAsset;
               }
               if(!(!this.var_425 || !this.var_425.content))
               {
                  ...
                  {
                     this.var_1053 = this._structure.renderManager.paletteManager.getPalette(this.var_114.paletteMapId);
                     if(this.var_1053 != null)
                     {
                        this.var_921 = this.var_425.content as BitmapData;
                        this.var_181 = new BitmapData(this.var_921.width,this.var_921.height);
                        this.var_2378 = this.var_1053.colorize(this.var_921.getPixels(this.var_921.rect));
                        this.var_181.setPixels(this.var_181.rect,this.var_2378);
                     }
                     else
                     {
                        this.var_181 = (this.var_425.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1419 == AvatarBodyPartType.const_248 || this.var_1419 == AvatarBodyPartType.const_1649 || this.var_1419 == AvatarBodyPartType.const_1609) && this.var_114.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_181.colorTransform(this.var_181.rect,this.var_114.color.colorTransform);
                  }
                  if(this.var_114.isBlendable)
                  {
                     this.var_181.colorTransform(this.var_181.rect,this.var_114.blendTransform);
                  }
                  this.var_919 = this.var_425.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_55)
                     {
                  ...
                  this.var_2380 = new ImageData(this.var_181,this.var_919,_loc7_);
                  this.var_920.push(this.var_2380);
               }
            }
            _loc8_--;
         }
         ...
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2379.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_55)
            {
