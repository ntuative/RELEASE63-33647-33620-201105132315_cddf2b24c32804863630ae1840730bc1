   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_270,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_223,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_267,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_68 && var_150 == "")
         {
            var_68.switchCategory(FigureData.const_223);
         }
      }
