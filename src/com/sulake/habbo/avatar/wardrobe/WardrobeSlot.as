package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_680 && this.var_1578)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_93,this.var_1044,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_35,parseInt(FigureData.const_823));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1578 && this.var_680 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_680 = this._controller.figureData.getFigureString();
               this.var_1044 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_2021,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_680)
               {
                  this._controller.loadAvatarInEditor(this.var_680,this.var_1044,this._controller.clubMemberLevel);
               }
         }
      }
