package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      public function init() : void
      {
         ...
         this.var_634 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_634.numGridItems > 0)
         {
            this.var_634.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_68 = null;
      ...
      public function update() : void
      {
         ...
         for each(_loc2_ in this.var_68.hotLooks)
         {
            ...
            this.var_634.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_634.getGridItemIndex(param2.parent);
