package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2429 = parseInt(param1.@precedence);
         this.var_2431 = String(param1.@activepartset);
         this.var_2432 = String(param1.@assetpartdefinition);
         this.var_2433 = String(param1.@lay);
         this.var_751 = String(param1.@geometrytype);
         this.var_2430 = Boolean(parseInt(param1.@main));
         this.var_2434 = Boolean(parseInt(param1.@name_6));
         this.var_2427 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "RoomWidgetStopEffectMessage"));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2428 = _loc6_;
            }
            else
            {
               this.var_1730[_loc5_] = _loc6_;
            }
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1730[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2428;
         }
         return _loc2_;
      }
