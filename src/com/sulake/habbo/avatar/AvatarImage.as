package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1354:String = "Default";
      
      private static const const_1352:int = 2;
      
      private static const const_1353:String = AvatarSetType.const_35;
      ...
      protected var var_1767:int;
      
      protected var var_285:IActiveActionData;
      
      protected var var_1085:Boolean;
      ...
      protected var var_680:AvatarFigureContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1353,const_1352);
         this.var_335 = new Array();
         this.var_909 = new ActiveActionData(AvatarAction.const_406);
         this.var_909.definition = this._structure.getActionDefinition(const_1354);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_680,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1649;
         if(param2 < AvatarDirectionAngle.const_1222)
         {
            param2 = AvatarDirectionAngle.const_320 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_320)
         {
            param2 -= NaN;
         }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_245.length == 1 && this.var_91 == this.var_1767)
         {
            return this.var_91 + this.var_490 + this.var_581 % 4;
         }
         if(this.var_245.length == 2)
         {
      ...
      private function getBodyParts(param1:String, param2:String, param3:int) : Array
      {
         if(param3 != this.var_2173 || param2 != this.var_2175 || param1 != this.var_2174)
         {
            ...
            this.var_1648 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_285.definition.geometryType,this.var_91);
         this.var_46.lock();
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_285.definition.geometryType,this.var_91);
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_335.push(new ActiveActionData(param1,param2,this.var_581));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_285 = this.var_909;
         this.var_285.definition = this.var_909.definition;
         this.resetBodyPartCache(this.var_909);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_490 = "";
         this.var_245 = this._structure.sortActions(this.var_335);
         if(this.var_245 == null)
         {
         ...
         {
            this.var_757 = this._structure.getCanvasOffsets(this.var_245,this._scale,this.var_91);
            for each(_loc4_ in this.var_245)
            {
               this.var_490 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_328)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1376 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1376 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1377 != this.var_490)
            {
               _loc1_ = true;
               this.var_1377 = this.var_490;
            }
         }
         this.var_1378 = true;
         return _loc1_;
            ...
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1649 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_322 || _loc1_.actionType == AvatarAction.const_231 || _loc1_.actionType == AvatarAction.const_438)
               {
                  this.var_910 = true;
               }
            }
