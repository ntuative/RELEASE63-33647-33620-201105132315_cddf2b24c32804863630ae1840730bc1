package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1452:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1451:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_814:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_1201:AvatarEditorHandler;
      ...
      private var var_1470:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_1044 = FigureData.const_80;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_196)
         {
            ...
            _loc2_.loadAvatarData(const_1452,FigureData.const_80);
            _loc3_.loadAvatarData(const_1451,FigureData.FEMALE);
            this.var_105 = new Map();
            this.var_518 = new Map();
            this.var_105.add(AvatarEditorFigureCategory.const_906,new BodyModel(this));
            this.var_105.add(AvatarEditorFigureCategory.const_52,new HeadModel(this));
            this.var_105.add(AvatarEditorFigureCategory.const_248,new TorsoModel(this));
            this.var_105.add(AvatarEditorFigureCategory.const_705,new LegsModel(this));
            if(param1 == null || param1.indexOf(AvatarEditorFigureCategory.HOTLOOKS) > -1)
            {
               this.var_105.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            }
            this.var_518.add(AvatarEditorSideCategory.const_106,new WardrobeModel(this));
            this.var_518.add(AvatarEditorSideCategory.const_563,new ClubPromoModel(this));
            this.var_196 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_105)
         {
            for each(_loc5_ in this.var_105)
            {
               _loc5_.reset();
            }
         }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_259 == null)
            {
               this.var_259 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_259.addChild(this._view.window);
               if(param5)
               {
                  this.var_259.center();
               }
            ...
            this.var_259.visible = !this.var_259.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_906);
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = this.var_105.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_814 = param2 as ISessionDataManager;
      }
      ...
      {
         this.var_968 = this.var_519.getFigureData(AvatarType.const_126);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1201 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_625[this.var_1044];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1470 != null)
         {
            ...
            this.var_1470.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1849;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1200 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1450)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1616.clone() as IWindowContainer,param1,_loc13_);
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1336.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1850)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1200 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1336.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1200 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_518.getValue(AvatarEditorSideCategory.const_106);
      }
