package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_908:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_580 = _loc4_.content as BitmapData;
         ...
         this.var_889 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_580.width,this.var_580.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_580,this.var_580.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_890.width,this.var_890.height,true,0);
            _loc5_ = this.var_890.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_908.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_889.width,this.var_889.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_889,this.var_889.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_908)
            {
               switch(this.var_908.clubLevel)
               {
                  case HabboClubLevelEnum.const_58:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_43:
                     _loc4_.style = HabboIconType.const_988;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_46:
                     _loc4_.style = HabboIconType.const_785;
                     _loc4_.visible = true;
               }
            }
            else
