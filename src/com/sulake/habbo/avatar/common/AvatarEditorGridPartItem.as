package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_1404:IWindow;
      
      private var var_743:IFigurePartSet;
      ...
      private const const_2200:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         this.var_743 = param3;
         this._window = param1;
         this.var_1404 = this._window.findChildByTag("BG_COLOR");
         this._colors = param4;
         ...
         if(param3 != null)
         {
            ...
            {
               this.var_1727 = Math.max(this.var_1727,_loc6_.colorLayerIndex);
            }
         }
         this.var_423 = this.var_68.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_697 != null && !this.var_1728)
            {
               _loc3_ = this.var_697;
            }
            else
            {
               _loc3_ = this.method_11();
               if(!_loc3_)
               {
                  return;
               }
         ...
         if(_loc2_)
         {
            if(this.var_743)
            {
               switch(this.var_743.clubLevel)
               {
                  case HabboClubLevelEnum.const_58:
                     _loc2_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_43:
                     _loc2_.style = HabboIconType.const_988;
                     break;
                  case HabboClubLevelEnum.const_46:
                     _loc2_.style = HabboIconType.const_785;
               }
            }
            else
            {
         ...
         if(this.isSelected)
         {
            this.var_1404.color = this.const_2201;
         }
         else
         {
            this.var_1404.color = this.const_2200;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_364[_loc6_] + "_" + FigureData.const_151;
      ...
      private function method_11() : BitmapData
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         var _loc3_:* = null;
         ...
         if(this.var_595 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1726)
               {
                  ...
                  this.var_1726 = _loc9_.content as BitmapData;
               }
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1728 && _loc2_.colorLayerIndex > 0)
               {
