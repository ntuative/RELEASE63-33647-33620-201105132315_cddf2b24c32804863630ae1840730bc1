package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:CategoryData = this.var_105[param1];
         if(_loc2_ == null)
         {
      ...
      {
         if(!this.var_105 || !this._controller || !this._controller.figureData)
         {
            return;
         }
         var _loc2_:CategoryData = this.var_105[param1];
      ...
      public function stripClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         var _loc2_:Array = this.var_105.getKeys();
         var _loc3_:Boolean = false;
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            _loc5_ = _loc2_[_loc4_];
            _loc6_ = this.var_105[_loc5_];
            _loc7_ = false;
      ...
      {
         var _loc3_:CategoryData = this.var_105[param1];
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc4_:CategoryData = this.var_105[param1];
         if(_loc4_ == null)
         {
            return;
         }
