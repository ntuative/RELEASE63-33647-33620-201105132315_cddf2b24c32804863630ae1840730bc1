package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1336:IWindowContainer;
      
      public static var var_1616:IWindowContainer;
      
      public static var var_2095:int = 6710886;
      ...
      private var var_370:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_527:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1223 = [];
         this.var_1461 = [AvatarEditorFigureCategory.const_906,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_248,AvatarEditorFigureCategory.const_705,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_106];
         super();
         ...
         if(var_1336 == null)
         {
            ...
            var_1336 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1616 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1616 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_446 = new Timer(1000);
         this.var_446.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1461;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_446.stop();
            this.var_446.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_446 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2610 = this.canChangeOutfit();
            this.var_446.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_370 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_370.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_370.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1223.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_370.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_370.numSelectables)
               {
                  this.var_370.getSelectableAt(_loc6_).x = this.var_370.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_370.setSelected(this.var_370.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_43) && (this.var_1876 == AvatarEditorSideCategory.const_106 || this.var_2611))
         {
         ...
         this.setViewToCategory(this.var_393);
      }
      ...
      {
         if(this.var_1876 == AvatarEditorSideCategory.const_106)
         {
            this.var_2611 = false;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_393 = param1;
         this.var_370.setSelected(this.var_370.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2609 = new Date().valueOf();
                  this.var_2610 = false;
                  this.var_446.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_527)
         {
            ...
            this.var_527 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_527.procedure = this.stripClubDialogEventProc;
            this.var_527.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2609 > 5000;
      }
   }
}
