package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         this.var_2490 = parseInt(param1.@paletteid);
         this.var_613 = new Dictionary();
         this.var_613["F"] = new Dictionary();
         this.var_613["M"] = new Dictionary();
         this.var_613["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_613["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_613["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_613["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      {
         return this.var_613[param1.toUpperCase()][Math.min(param2,1)];
      }
