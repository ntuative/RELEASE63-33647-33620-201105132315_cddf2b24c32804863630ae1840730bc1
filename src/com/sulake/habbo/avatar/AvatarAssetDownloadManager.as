package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_474:AssetLoaderStruct;
      ...
      private const const_2238:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_474 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_1073 = new Timer(this.const_2238,1);
         this.var_1073.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_474)
         {
            this.var_474.addEventListener(AssetLoaderEvent.const_29,this.onConfigurationComplete);
            this.var_474.addEventListener(AssetLoaderEvent.const_48,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_474)
         {
            this.var_474.removeEventListener(AssetLoaderEvent.const_29,this.onConfigurationComplete);
            this.var_474.removeEventListener(AssetLoaderEvent.const_48,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         else
         {
            ...
            if(this.var_1605.indexOf("?") > 0)
            {
               _loc2_ = this.var_1605 + "&retry=" + this.var_1071;
            }
            else
            {
               _loc2_ = this.var_1605 + "?retry=" + this.var_1071;
            ...
            this.var_474 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function loadFigureMapData(param1:XML) : void
      {
         ...
         this.var_2070 = true;
         for each(_loc2_ in this.var_1323)
         {
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_2070)
         {
            this.var_1323.push([param1,param2]);
            return;
         }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_1072)
         {
            _loc7_ = true;
            _loc4_ = this.var_1072[_loc3_];
      ...
      {
         var _loc1_:* = null;
         while(this.var_856.length > 0 && this.var_857.length < this.const_1752)
         {
            _loc1_ = this.var_856[0];
            _loc1_.startDownloading();
            this.var_857.push(this.var_856.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_856.indexOf(param1) == -1 && this.var_857.indexOf(param1) == -1)
         {
