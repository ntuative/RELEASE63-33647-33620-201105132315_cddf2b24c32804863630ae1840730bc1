package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_760:PaletteManager;
      ...
      private var var_1789:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_336 = RenderMode.const_1685;
         ...
         this.var_107.add(AvatarType.const_126,_loc4_);
         ...
         this.var_107.add(AvatarType.const_57,_loc4_);
         ...
         this.var_760 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_307.init();
         this.var_760.init();
         _loc2_ = this.var_107.getValue(AvatarType.const_126) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_107.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_107.getValue(AvatarType.const_126) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_969)
         {
            if(this.var_2444 && this.var_2443 && this.var_2445)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_107.getValue(AvatarType.const_126) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1789)
         {
            this.var_1789 = new AvatarFigureContainer(this.const_2208);
         }
         this.var_227.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1789,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1798)
         {
            _loc6_ = !this.var_307.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_307.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_107.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_107.getValue(AvatarType.const_57);
      ...
      {
         var _loc3_:AvatarStructure = this.var_107.getValue(AvatarType.const_126) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_57:
               _loc3_ = this.var_107.getValue(AvatarType.const_57) as AvatarStructure;
               break;
            default:
