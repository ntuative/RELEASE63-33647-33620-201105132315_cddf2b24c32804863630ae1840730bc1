package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_680:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_680 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_680.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1402 = this.var_1153;
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_680,_loc13_,"pet",_loc12_.getDirection(),[]);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_680,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_93)
               {
                  _loc17_ = 6;
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_490 = this.var_490 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_909);
         this.getCache().resetBodyPartCache(this.var_909);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1401 = this._structure.sortActions(this.var_335);
         ...
         {
            this.var_757 = this._structure.getCanvasOffsets(this.var_1401,this._scale,this.var_91);
         }
      }
