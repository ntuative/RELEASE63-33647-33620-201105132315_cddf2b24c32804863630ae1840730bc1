package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1757:Number = 1.0;
      
      private var var_1760:Number = 1.0;
      
      private var var_1758:Number = 1.0;
      ...
      {
         super();
         this.var_2004 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2805 = parseInt(_loc2_,16);
         this.var_2806 = parseInt(_loc3_,16);
         ...
         this.var_779 = new ColorTransform(this.var_1757,this.var_1760,this.var_1758,this._alphaMultiplier);
         this.var_1289 = this.generatePaletteMapForGrayscale(this.var_2806,this.var_2805);
      }
      ...
      {
         return this.var_1289.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1289.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1289.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1289.getValue("alphas") as Array;
      }
