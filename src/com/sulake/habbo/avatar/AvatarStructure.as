package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_843:AnimationManager;
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_909 = this.var_1049.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         {
            if(this.var_556 == AvatarType.const_126)
            {
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         ...
         return this.var_400.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_400.injectXML(param1);
      }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_843.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_400.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_400.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_843.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_843.getAnimation(param1) as Animation;
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_682[param1] = new Dictionary();
         }
         if(this.var_682[param1][param2])
         {
            return this.var_682[param1][param2];
         }
         this.var_682[param1][param2] = this.var_400.getMandatorySetTypeIds(param1,param2);
         return this.var_682[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_400.getDefaultPartSet(param1,param2);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_843.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1681[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc9_ = this.var_843.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_400.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_400.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
