package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1332 = this.var_2079.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1332)
         {
            this.var_1332.procedure = this.onButtonClick;
         }
         this.var_1331 = this.var_2079.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1331)
         {
      ...
      {
         if(this.var_284 >= this.var_62.length - 1)
         {
         ...
         if(this.var_284 <= 0)
         {
            this.var_1332.disable();
         }
         else
         {
            this.var_1332.enable();
         }
      }
      ...
      {
         ++this.var_284;
         this.var_284 = Math.min(this.var_284,this.var_62.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_62[this.var_284][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_62[this.var_284][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_62[this.var_284][1]).value;
