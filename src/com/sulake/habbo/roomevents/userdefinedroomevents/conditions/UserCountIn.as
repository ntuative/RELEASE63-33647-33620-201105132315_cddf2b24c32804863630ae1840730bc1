package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1295:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1295.getValue());
      ...
      {
         this.var_83 = param2;
         this.var_1295 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1295.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1295.setValue(1);
         this.var_1296 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1296.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1296.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1295.setValue(_loc3_);
         this.var_1296.setValue(_loc4_);
      }
