package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_2027:TriggerConfs;
      
      private var var_2026:ActionTypes;
      
      private var var_2028:ConditionTypes;
      ...
      private var var_1298:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2027 = new TriggerConfs();
         this.var_2026 = new ActionTypes();
         this.var_2028 = new ConditionTypes();
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1298 = new SliderWindowController(this.var_83,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_83.assets,0,20,1);
         this.var_1298.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1298.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_842.hideAll(this.var_280);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_842.showAll(this.var_280);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1298.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1298.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1584) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1584 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2027);
         this.refreshConfigureElement(this.var_2026);
         this.refreshConfigureElement(this.var_2028);
