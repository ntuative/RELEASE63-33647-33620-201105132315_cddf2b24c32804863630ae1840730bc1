package com.sulake.habbo.roomevents.userdefinedroomevents.triggerconfs
{
   ...
   public class AvatarEntersRoom implements TriggerConf
   {
      ...
      {
         this._cont = param1;
         this.getCertainAvatarRadio().addEventListener(WindowEvent.const_327,this.onCertainAvatarSelect);
         this.getCertainAvatarRadio().addEventListener(WindowEvent.const_504,this.onCertainAvatarUnselect);
      }
