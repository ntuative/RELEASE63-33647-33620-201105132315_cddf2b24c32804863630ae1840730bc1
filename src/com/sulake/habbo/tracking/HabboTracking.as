package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1221:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1492 = new Array(const_1046);
         var _loc4_:int = 0;
         while(_loc4_ < const_1046)
         {
            this.var_1492[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1619,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1907,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1754,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_936,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1241,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1221)
            {
               this.var_1221.release(new IIDHabboWindowManager());
               this.var_1221 = null;
            }
            if(this.var_302)
            {
            ...
            if(this.var_208)
            {
               if(!this.var_208.disposed)
               {
                  ...
                  Component(this.var_208).events.removeEventListener(HabboFriendListTrackingEvent.const_476,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_199,this.onRoomAdClick);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_187)
         {
            if(this.var_263 != null)
            {
               this.var_263.configuration = this.var_187;
            }
            if(this.var_264 != null)
            {
               this.var_264.configuration = this.var_187;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1749);
            if(this.var_187)
            {
               if(this.var_636 != null)
               {
                  this.var_636.configure(this.var_187);
               }
               if(this.var_444 != null)
               {
                  this.var_444.configure(this.var_187);
               }
               if(this.var_443 != null)
               {
                  this.var_443.configure(this.var_187);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_793,this.onHotelViewEvent);
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_793)
         {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1632);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_682:
               this.trackLoginStep(HabboLoginTrackingStep.const_1848,String(this._communication.port));
               break;
      ...
      {
         this.var_1221 = IHabboWindowManager(param2);
         if(this.var_1221)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_187)
            {
               if(this.var_187.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1492)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1230);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1230,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_208).events.addEventListener(HabboFriendListTrackingEvent.const_476,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_476:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1241,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_936,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_199,this.onRoomAdClick);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_302.events.addEventListener(AdEvent.const_567,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_339)
         {
            if(this.var_1869 < 1)
            {
               if(!this.var_320)
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_444)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_444.frameRate),_loc2_);
                  ++this.var_1869;
               }
            }
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1870;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1870);
         }
         if(this.var_526 > -1 && _loc2_ - this.var_526 > 15000)
         {
            ++this.var_1868;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1868);
         }
         this.var_526 = _loc2_;
         if(this.var_264 != null)
         {
            this.var_264.update(param1,this.var_526);
         }
         if(this.var_263 != null)
         {
            this.var_263.update(param1,this.var_526);
         }
         if(this.var_444 != null)
         {
         ...
         if(this.var_636 != null)
         {
            this.var_636.update(this.var_526);
         }
      }
   }
}
