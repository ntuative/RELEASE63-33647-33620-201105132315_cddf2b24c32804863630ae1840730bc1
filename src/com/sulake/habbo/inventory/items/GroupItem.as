package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1439:int = 13421772;
      
      private static const const_1438:int = 10275685;
      ...
      private const const_1936:Number = 1;
      
      private const const_1935:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2480 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2914 == FurniModelCategory.const_40)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1459));
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_920)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         this.var_1404.color = !!this.var_1809 ? uint(const_1438) : uint(const_1439);
         this.var_2480.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2138 && this.getRecyclableCount() > 0)
            {
