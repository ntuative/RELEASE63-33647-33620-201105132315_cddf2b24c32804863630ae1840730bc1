package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private const const_1939:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this._controller.inventoryViewOpened(this.var_839);
      }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_839);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            case InventoryCategory.const_68:
               ...
               break;
            case InventoryCategory.const_120:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_2020);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_398 == InventoryCategory.const_120)
            {
               this.toggleCategoryView(InventoryCategory.const_120);
            }
            else if(this.var_398 == InventoryCategory.const_68)
            {
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(!this.var_1043)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc3_.x = _loc4_.width - _loc3_.width - const_1076;
               _loc3_.y = const_1076;
            }
         ...
         if(_loc1_ > 0)
         {
            ...
            this.var_1043.findChildByName("count").caption = _loc1_.toString();
         }
         else
         {
