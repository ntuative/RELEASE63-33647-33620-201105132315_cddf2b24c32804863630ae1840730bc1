package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_93 = this.var_618.height;
         this.var_1193 = param5;
         this.var_959 = param6;
         this.var_229 = Math.floor(this.var_1193 / this._thumbWidth);
         this.var_28 = new BitmapData(this.var_1193,this.var_959);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_28 = new BitmapData(Math.max(this.var_229 * this._thumbWidth,this.var_1193),Math.max(this.var_617 * this.var_93,this.var_959),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_229 && this.var_28.height < _loc3_.y * this.var_93)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_229 - 1),this.var_93);
         ...
         _loc4_ = new Rectangle(0,this.var_93,this._thumbWidth * (this.var_229 - 1),this.var_28.height - this.var_93);
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_28.height < this.var_959)
         {
            _loc12_ = new BitmapData(this.var_28.width,this.var_959);
