package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1841:uint = 9;
      
      public static const const_190:uint = 0;
      
      public static const const_193:uint = 1;
      
      public static const const_439:uint = 2;
      
      public static const const_308:uint = 3;
      
      public static const const_622:uint = 4;
      
      public static const const_247:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_56.updateItemList(this.var_784);
         this.var_56.updateItemList(this.var_1484);
      ...
      public function close() : void
      {
         if(this.var_861)
         {
            if(this._state != const_190 && this._state != const_247)
            {
      ...
      {
         this.var_56.setMinimized(param1 != InventoryCategory.const_68);
         this.var_13.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_785 + " OTHER: " + this.var_1215);
         ...
         {
            case const_190:
               if(param1 == const_193 || param1 == const_247)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_56.method_3(TradingView.const_1200);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_784)
            {
               this.var_785 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1215 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_56.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_784)
            {
               this.var_56.method_3(TradingView.const_1236);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_260.length < const_1841)
         {
