package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_684);
         _loc2_.refreshViews();
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_359);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this.var_13.toggleInventorySubPage(InventorySubCategory.const_302);
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_120);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_377);
      ...
      {
         var _loc2_:* = null;
         if(this.var_13.isInventoryCategoryInit(InventoryCategory.const_377))
         {
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this.var_13.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_436));
