package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1067:int = 42;
      
      private static const const_1066:int = 120;
      ...
      private var var_796:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_452.add(FurniModelCategory.const_40,new FurniGridView(this.var_68,FurniModelCategory.const_40,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_452.add(FurniModelCategory.const_45,new FurniGridView(this.var_68,FurniModelCategory.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_452.getValue(this.var_451);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_68.getCategoryContent(this.var_451);
         ...
         if(this.var_2654 == _loc2_)
         {
            return;
         }
         this.var_2654 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_452.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_452.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_452.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_68.getUnseenItemCount(UnseenItemCategoryEnum.const_440) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_68.getUnseenItemCount(UnseenItemCategoryEnum.const_436) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_68.getGroupItemInIndex(_loc3_,this.var_451);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_219);
            ...
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_192);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_796 && this.var_796.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1283)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1066)
         {
            _loc3_ = const_1066;
         }
         else if(_loc3_ < const_1067)
         {
            _loc3_ = const_1067;
         }
         else
         ...
         else if(param1.type == WindowEvent.const_49)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_289);
            }
         }
      }
