package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1503:int = 1000;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_539 = [];
         this.var_540 = [];
         this.var_653 = new Timer(const_1502,1);
         this.var_653.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2688 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_144,this.onObjectPlaced);
               }
            ...
            {
               this.var_653.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_653.stop();
               this.var_653 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_806 == null)
         {
            this.var_806 = this._windowManager.buildFromXML(this.var_2688) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_806.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_806.clone() as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_68 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_289:
                  this._controller.toggleInventoryPage(InventoryCategory.const_120);
            }
         }
      }
      ...
      {
         this.var_2686 = getTimer();
         this.switchCategory(const_289);
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_377);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_652.add(const_40,new Array());
         this.var_652.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_40;
            _loc5_ = this.var_539.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_45;
            _loc5_ = this.var_540.indexOf(param1.ref) > -1;
         }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_289)
            {
      ...
      {
         return getTimer() < this.var_2686 + const_1503;
      }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_302;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_357 || _loc3_.category == FurniCategory.const_334 || _loc3_.category == FurniCategory.const_326)
         {
            if(param1)
            {
               return false;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_302:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_920)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_539.indexOf(_loc2_) == -1)
            {
               this.var_539.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_440:
               return this.var_539.length;
            case UnseenItemCategoryEnum.const_436:
               return this.var_540.length;
            default:
               return this.var_539.length + this.var_540.length;
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         switch(this._view.visibleCategoryId)
         {
            case const_45:
               ...
               {
                  _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_436));
                  this.var_540 = [];
            ...
            case const_40:
               ...
               {
                  _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_440));
                  this.var_539 = [];
