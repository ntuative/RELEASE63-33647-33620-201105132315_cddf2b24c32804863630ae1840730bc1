package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_216:PetsGridItem;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_216);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_535.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_257.removeGridItem(_loc2_.window);
         if(this.var_216 == _loc2_)
         {
            this.var_216 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_535 == null || this.var_535.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_535.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_535.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_535.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_216.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_216 != null)
         {
            this.var_216.setSelected(false);
         }
         this.var_216 = param1;
         if(this.var_216 != null)
         {
            this.var_216.setSelected(true);
         }
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1068;
         }
         else
         {
            _loc2_ = this.const_1065;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_68.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_440) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_68.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_436) > 0;
