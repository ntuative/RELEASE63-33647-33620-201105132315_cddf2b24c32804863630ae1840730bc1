package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_44:
               this.var_1504.setSelectedGridItem(this);
               this.var_1505 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1505 = false;
                  this.var_1504.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1404)
         {
            return;
         }
         this.var_1404.color = !!this.var_2647 ? uint(const_1438) : uint(const_1439);
         this.var_2480.visible = param1;
      }
