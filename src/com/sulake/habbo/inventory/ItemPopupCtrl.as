package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_1437:int = 250;
      
      private static const const_1436:int = 100;
      
      private static const const_1434:int = 180;
      ...
      {
         this.var_361 = new Timer(const_1437,1);
         this.var_362 = new Timer(const_1436,1);
         super();
         if(param1 == null)
         {
            return;
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1434,param3.width),Math.min(const_1435,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1808);
         switch(this.var_1808)
         {
            case const_1196:
               this.var_82.x = -1 * this.var_82.width - const_1026;
               break;
            case const_606:
               this.var_82.x = this._parent.width + const_1026;
         }
