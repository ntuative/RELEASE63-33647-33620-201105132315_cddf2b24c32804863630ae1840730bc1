package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         this.var_841 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_841.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1048.length < var_2023)
         {
            ...
            param1.width = this.var_841.width;
            param1.height = this.var_841.height;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1583)
         {
