package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1211:IDropMenuWindow;
      ...
      public function populate() : void
      {
         ...
         this.var_1211 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1211);
         this.var_1211.procedure = this.onSelectTemplate;
         this.var_1011 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_814,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_648 || this.var_507.text == "")
         {
            this.var_35.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1011.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1686,_loc2_,this.var_507.text,"",""));
         if(this.var_1525.isSelected || this.var_1524.isSelected || this.var_1011.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1525.isSelected,this.var_1524.isSelected,this.var_1011.isSelected));
         }
         this.dispose();
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1211.selection];
         if(_loc3_ != null)
         {
            this.var_648 = false;
