package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_1790;
      ...
      {
         return WindowTracker.const_1881;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.messageTemplates[this.var_1211.selection];
         if(_loc3_ != null)
         {
            this.var_648 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModMessageMessageComposer(this.var_1435,this.var_507.text,this.var_1434));
         this.dispose();
      }
