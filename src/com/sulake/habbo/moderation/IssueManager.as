package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1131:String = "issue_bundle_open";
      
      public static const const_873:String = "issue_bundle_my";
      
      public static const const_1324:String = "issue_bundle_picked";
      
      public static const const_1636:int = 15000;
       
      
      private var var_67:ModerationManager;
      
      private var var_586:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_586 = new IssueBrowser(this,this.var_67.windowManager,this.var_67.assets);
         this.var_1117 = [];
         this.var_1118 = [];
         this.var_896 = new Map();
         this.var_2255 = parseInt(this.var_67.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1682 = new Timer(const_1636,0);
         this.var_1682.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1682.start();
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_586 == null || !this.var_586.isOpen())
         {
            this.var_67.soundManager.playSound(HabboSoundTypesEnum.const_1298);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1771)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         {
            _loc6_ = this.getBundles(const_873);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1118.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2255);
            }
         }
