package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2222:String = "my_issues";
      
      private const const_2224:String = "open_issues";
      
      private const const_2223:String = "picked_issues";
      
      private const const_2243:String = "closed_issues";
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2222:
               if(this.var_1927 == null)
               {
                  this.var_1927 = new MyIssuesView(this.issueManager,this,this.var_269.container);
               }
               return this.var_1927;
            case this.const_2224:
               if(this.var_1928 == null)
               {
                  this.var_1928 = new OpenIssuesView(this.issueManager,this,this.var_269.container);
               }
               return this.var_1928;
            case this.const_2223:
               if(this.var_1929 == null)
               {
                  this.var_1929 = new PickedIssuesView(this.issueManager,this,this.var_269.container);
               }
