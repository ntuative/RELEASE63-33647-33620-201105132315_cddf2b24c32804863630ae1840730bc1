package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_944:OffenceData;
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1790;
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            this._frame.findChildByName("offence_txt").caption = this.var_944.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_943 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_943.offences,this.var_1167,this.onOffenceButton);
         }
         else
         {
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1435,this.var_507.text,this.var_1434));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_943 = this.var_35.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_944 = this.var_943.offences[_loc3_];
         this.var_507.text = this.var_944.msg;
         this.var_648 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1435,this.var_507.text,this.var_1434));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1435,this.var_507.text,this.getBanLength(),this.var_1434));
         this.dispose();
      }
