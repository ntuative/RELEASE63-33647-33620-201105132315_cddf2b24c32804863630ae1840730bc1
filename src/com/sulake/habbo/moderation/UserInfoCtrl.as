package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1095:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_1097) + " mins ago";
         }
         if(param1 < 2 * const_1096)
         {
            return Math.round(param1 / const_1098) + " hours ago";
         }
         if(param1 < 2 * const_1095)
         {
            return Math.round(param1 / const_1096) + " days ago";
         }
         return Math.round(param1 / const_1095) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1317.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_35.getXmlWindow("user_info"));
            this.var_1317.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1135,this._data.userId),this._callerFrame,this.var_1318,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1318,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1434),this._callerFrame,this.var_1318,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1434),this._callerFrame,this.var_1318,false,true);
      }
