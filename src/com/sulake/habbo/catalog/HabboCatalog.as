package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_1116:IRoomSession;
      ...
      private var var_2665:GiftWrappingConfiguration;
      
      private var var_1245:ClubGiftController;
      
      private var var_536:ClubBuyController;
      ...
      private const const_1939:Point = new Point(100,20);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1736);
               return;
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_536.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_144,this.onObjectPlaced);
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_187.getKey("client.credits.embed.enabled","false") == "RoomWidgetStopEffectMessage";
         if(false && _loc1_)
         {
      ...
      {
         var _loc2_:Array = this.var_802.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer.position = this.const_1939;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               this.var_1909 = param1.session.isPrivateRoom;
               this.var_1116 = param1.session;
               if(this.var_96 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1245 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_536 == null)
         {
            this.var_536 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_801 && this.var_801 != "")
         {
            this.var_377.openPage(this.var_801);
            this.var_801 = "";
            this.var_1002 = -1;
         }
         else if(this.var_1002 > -1)
         {
            this.var_377.openPageById(this.var_1002,this.var_1908);
            this.var_1002 = -1;
            this.var_1908 = -1;
            this.var_801 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2663 && this._soundManager != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_67,this.var_110.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1254);
         }
         this.var_2664 = false;
         if(this._chargeConfirmationDialog != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1245.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_96.setFinished(_loc2_.method_7,_loc2_.prizeId);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2665 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_802.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_802.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "RoomWidgetStopEffectMessage" == this.var_187.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
      ...
      {
         if(!this.var_187.keyExists("catalog.drag_and_drop") || this.var_187.getKey("catalog.drag_and_drop") != "RoomWidgetStopEffectMessage")
         {
            return false;
         }
         if(!this.var_1116 || !this.var_1116.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_219);
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_192);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1244 && param1.type == RoomEngineObjectEvent.const_144)
         {
            ...
            _loc3_ = this.var_1003.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_66 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_1003);
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_354,0.5);
            }
         }
      }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc2_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_219);
         ...
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_192);
