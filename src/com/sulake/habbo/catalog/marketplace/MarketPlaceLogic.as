package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_2072:int = 1;
      
      public const const_2075:int = 2;
      
      public const const_2244:int = 3;
      ...
      private var var_2296:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_246);
            this.var_246 = null;
         }
      ...
      {
         this.requestOffers(this.var_2294,this.var_2299,this.var_2159,this.var_2298);
      }
      ...
      {
         if(!this.var_246 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_246.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         this.showConfirmation(this.const_2072,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_615)
            {
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_246.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_246.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_246.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_246.add(parser.offerId,updateItem);
            }
            this.var_246.remove(parser.requestedOfferId);
      ...
      {
         if(param1.furniCategoryId != this.var_2295 || param1.furniTypeId != this.var_2300)
         {
            return;
         }
