package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2973:String = "magic.credits";
      
      private var var_2933:String = "magic.pixels";
      
      private var var_2932:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2933);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2932,true);
      }
