package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1495:Number = 4285716709;
      ...
      private var var_1881:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1881 == 4294967295)
            {
               this.var_1881 = _loc1_.color;
            }
            _loc1_.color = const_1495;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1840;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1828;
            }
         }
      }
      ...
      {
         this.var_60 = navigator.catalog.windowManager.buildFromXML(var_1497) as IItemListWindow;
         if(this.var_60 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1496) as IWindowContainer;
         }
         else
         {
