package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2227:int = 10;
      ...
      private const const_1937:uint = 4.293848814E9;
      
      private const const_1938:uint = 4.294967295E9;
      
      private const const_1390:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1699 = _loc1_.stuffTypes;
            this.var_837 = _loc1_.boxTypes;
            this.var_838 = _loc1_.ribbonTypes;
            this.var_1293 = this.var_1699[0];
            this.var_395 = this.var_837[0];
            this.var_397 = this.var_838[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_397 < 0)
         {
            this.var_397 = this.var_838.length - 1;
         }
         if(this.var_397 > this.var_838.length - 1)
         {
            this.var_397 = 0;
         }
         if(this.var_395 < 0)
         {
            this.var_395 = this.var_837.length - 1;
         }
         if(this.var_395 > this.var_837.length - 1)
         {
            this.var_395 = 0;
         }
         var _loc1_:int = this.var_837[this.var_395] * 1000 + this.var_838[this.var_397];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_95.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1293,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1577 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1699;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1293);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_837[this.var_395]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_838[this.var_397]);
         this._catalog.purchaseProductAsGift(this.var_1576,this.var_95,this.var_1575,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1576,this.var_95.offerId,this.var_1575);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_107:
               ...
               if(this.var_2821 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_231)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_2227)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2821 = _loc3_.text;
               break;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_679 == null)
         {
            this.var_679 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_679.procedure = this.suggestionsEventHandler;
         }
         if(this.var_279 == null || this.var_679 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_679.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1390;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1937) : uint(this.const_1938);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1293;
               }
            }
            _loc4_++;
         }
