package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private function setOfferData(param1:IPurchasableOffer) : void
      {
         ...
         this.var_1832 = param1.productContainer.firstProduct.productClassId;
         this.var_1833 = param1.productContainer.firstProduct.productData;
         this.var_652 = param1.productContainer.firstProduct.furnitureData;
         this.var_1575 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_218,this._category,this.var_1925,this._x,this.var_173,this._direction,this._offerId,this.var_1832].toString();
      }
