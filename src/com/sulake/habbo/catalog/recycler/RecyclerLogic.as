package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_628 != const_1035;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1852 != RecyclerStatusMessageEvent.const_1215;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_628 == const_448;
      }
      ...
      {
         this.var_628 = const_1036;
         this.var_119 = new Array(const_191);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1687:
               this.var_628 = const_448;
            ...
            case RecyclerStatusMessageEvent.const_1215:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1731:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1166:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1864:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_119.length < const_191)
         {
            return false;
         }
         var _loc1_:int = 0;
