package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1915:String = "ctlg_";
       
      
      protected var var_2133:XML;
      ...
      private var var_1164:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1165);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1165);
      }
      ...
      {
         var _loc2_:String = const_1915 + param1;
         ...
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2133) as IWindowContainer;
         if(this._window == null)
         {
      ...
      {
         this.method_5(this._window);
         this.initializeWidgets();
      }
      
      private function method_5(param1:IWindowContainer) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(param1 != null)
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1677:
               if(this.var_1164 == null)
               {
                  this.var_1164 = new ItemGridCatalogWidget(param1);
                  this.var_36.push(this.var_1164);
               }
               break;
