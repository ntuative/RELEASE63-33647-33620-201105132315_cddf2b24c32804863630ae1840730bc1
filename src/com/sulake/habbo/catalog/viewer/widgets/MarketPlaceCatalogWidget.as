package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2218:int = 40;
      
      private const const_2219:int = 10;
      
      private var var_793:Array;
      
      private var var_1506:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_530)
         {
            this.var_530.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_530 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_530)
         {
            this.var_530 = new Timer(25);
            this.var_530.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1232 = 0;
         this.populateList();
         this.var_530.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1232 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1232));
            ++this.var_1232;
            _loc1_++;
         }
         return false;
         ...
         else if(param1.type == WindowEvent.const_107)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2219;
                  break;
               case "search_input":
                  _loc8_ = this.const_2218;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1506.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_49)
