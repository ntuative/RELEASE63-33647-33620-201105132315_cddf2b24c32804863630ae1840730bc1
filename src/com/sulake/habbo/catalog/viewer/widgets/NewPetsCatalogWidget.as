package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         events.addEventListener(WidgetEvent.const_760,this.onApproveNameResult);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_210 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1499 && _loc2_ < this.var_210.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_537,this.var_210[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_210 != null && this.var_210.length > 0)
         {
            ...
            this.var_378 = this.var_210[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_537,this.var_378),this.getRaceLocalizationKey(this.var_537,this.var_378));
            }
         }
         return this.getRaceLocalizationKey(this.var_537,this.var_378);
      }
      ...
      {
         if(param1.productCode == this.var_2666)
         {
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_378 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_537;
         var _loc3_:int = this.var_378;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_378 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
