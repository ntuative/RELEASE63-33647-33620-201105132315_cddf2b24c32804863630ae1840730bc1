package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2666 = _loc3_.localizationId;
         this.var_379 = [];
         if(page && false && page.viewer.catalog)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(this.var_538 < 0 || this.var_538 > this.var_379.length)
         {
            this.var_538 = 0;
         }
         this.updateImage();
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_210 == null || this.var_805 >= this.var_210.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_538 >= 0 && this.var_538 < this.var_379.length)
         {
            _loc7_ = this.var_379[this.var_538] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_210[this.var_805] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_537,_loc3_,_loc2_,AvatarScaleType.const_55,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_331,AvatarAction.const_887);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_538 >= this.var_379.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_379[this.var_538] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_210[this.var_805] as int;
