package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_471:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer)
      {
         ...
         this.var_655 = [0,0,0];
         this.var_105 = ["group.walls","group.floors","group.views"];
         super(param1);
         this.var_471 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_471)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_471.numSelectables)
            {
               _loc3_ = this.var_471.getSelectableAt(_loc2_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_105[this.var_497]);
      ...
      {
         var _loc2_:int = this.var_655[this.var_497];
         var _loc3_:Offer = this.var_200[this.var_497][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_200[this.var_497][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_655[this.var_497] = (this.var_200[this.var_497] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_655[0];
         var _loc2_:int = this.var_655[1];
         var _loc3_:int = this.var_655[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_433 || _loc1_.pricingModel == Offer.const_413))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_63 || _loc2_.productType == ProductTypeEnum.const_82))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_471.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_471.setSelected(this.var_471.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_200[this.var_497],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_655[this.var_497];
