package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1115 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1679 = new Point(this.var_86.x,this.var_86.y);
         this.var_495 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1389 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1678 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1115.text = _loc5_;
         this.var_894.height = this.var_894.textHeight + 5;
         this.var_1115.y = this.var_894.y + this.var_894.height;
         this.var_1115.height = Math.max(130,this.var_1115.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_468:
                  _loc6_ = this.var_1678.clone();
                  if(this.var_495 != null)
                  {
                     this.var_495.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_495,this.var_1389,this.var_1779);
                     ...
                     case ProductTypeEnum.const_205:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_331,AvatarAction.const_471);
                              _loc16_.appendAction(AvatarAction.const_328,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2250)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            this.var_86.x = this.var_1679.x;
            this.var_86.y = this.var_1679.y;
            if(param3 != null)
            {
