package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1070.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1070 = null;
         }
         if(this.var_1069 != null)
         {
            this.var_1069.removeEventListener(WindowKeyboardEvent.const_214,this.windowKeyEventProcessor);
            this.var_1069 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1070 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1070 != null)
         {
            this.var_1070.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1069 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1069 != null)
         {
            this.var_1069.addEventListener(WindowKeyboardEvent.const_214,this.windowKeyEventProcessor);
         }
         return true;
      }
