package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1459:String = "go.friendbar";
      
      private static const const_1458:String = "chat_btn_click";
      
      private static const const_1461:String = "find_friends_btn_click";
      
      private static const const_1041:String = "Toolbar";
      
      private static const const_1040:String = "open";
      
      private static const const_1039:String = "close";
      
      private static const const_1460:String = "FRIENDLIST";
      
      private static const const_1457:String = "MESSENGER";
       
      
      private var var_87:IHabboCommunicationManager;
      
      private var var_317:IHabboFriendList;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_317)
            {
               this.var_317.release(new IIDHabboFriendList());
               this.var_317 = null;
            }
            if(this.var_440)
            {
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_653,const_654,const_1459));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_440)
         {
            ...
            if(this.var_87)
            {
               this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_653,const_654,const_1458));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_653,const_654,const_1461));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_317)
         {
            ...
            {
               if(!this.var_317.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_317.openFriendRequests();
                  }
                  else
                  {
                     this.var_317.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_317.mainWindow;
               ...
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1041,const_1460,!!this.var_317.isOpen() ? const_1040 : const_1039));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_440)
         {
            if(!this.var_440.disposed)
            {
               ...
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1041,const_1457,!!this.var_440.isOpen() ? const_1040 : const_1039));
               }
            }
         }
      }
      ...
      {
         this.var_317 = param2 as IHabboFriendList;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_136 = !!const_299 ? this.sortByNameAndOnlineStatus(this.var_136) : this.sortByName(this.var_136);
         }
