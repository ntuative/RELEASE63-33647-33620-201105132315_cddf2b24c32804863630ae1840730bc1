package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class FriendListIcon extends Icon
   {
      ...
      private static const const_1022:int = 200;
      ...
      override public function notify(param1:Boolean) : void
      {
         super.notify(param1);
         this.enable(param1);
         toggleTimer(param1 || _hover,!!_hover ? int(const_1022) : int(const_1021));
         if(!var_879 && !_hover)
         {
      ...
      {
         super.hover(param1);
         toggleTimer(param1 || var_879,!!_hover ? int(const_1022) : int(const_1021));
         if(!var_879 && !_hover)
         {
            image = this._assets.getAssetByName("icon_friendlist_png") as BitmapDataAsset;
         }
