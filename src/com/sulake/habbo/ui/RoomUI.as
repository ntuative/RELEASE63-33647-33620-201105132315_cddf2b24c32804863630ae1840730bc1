package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      {
         this.var_1411 = RoomDesktop.const_535;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_912.release(new IIDHabboModeration());
            this.var_912 = null;
         }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1736 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_302.events.addEventListener(AdEvent.const_475,this.adEventHandler);
            this.var_302.events.addEventListener(AdEvent.const_488,this.adEventHandler);
            this.var_302.events.addEventListener(AdEvent.const_567,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_912 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_912);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_16)
         {
            this.var_16.events.addEventListener(RoomSessionEvent.const_233,this.roomSessionStateEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_612,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPresentEvent.const_318,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_566,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_474,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_766,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1281,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1274,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_909,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_698,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_159,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionDimmerPresetsEvent.const_540,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionFriendRequestEvent.const_163,this.roomSessionEventHandler);
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_89:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_680);
               break;
            case RoomSessionEvent.const_90:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_833);
               }
         }
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_594,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_983,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_941,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_982,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_588,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_246,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_582 || param1.type == RoomEngineEvent.const_594)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_339:
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_964);
               ...
               if(this._config.getKey("purse.widget.enabled","0") == "1")
               {
                  ...
                  _loc3_.initializeWidget(RoomWidgetEnum.const_398);
               }
               if(!_loc5_)
               {
               ...
               if(this.var_1411 != RoomDesktop.const_535)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_341,this.var_1411);
               }
               if(this.var_302 != null)
               {
            ...
            case RoomEngineEvent.const_312:
               ...
               break;
            case RoomEngineRoomColorEvent.const_983:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.createWidget(RoomWidgetEnum.const_749);
         _loc3_.init();
