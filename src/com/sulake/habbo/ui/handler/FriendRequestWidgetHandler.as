package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_784);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_827);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_970);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_784:
            ...
            case RoomWidgetFriendRequestMessage.const_827:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_970:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_163);
         _loc1_.push(FriendRequestEvent.const_61);
         _loc1_.push(FriendRequestEvent.const_309);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_163:
            ...
            case FriendRequestEvent.const_309:
