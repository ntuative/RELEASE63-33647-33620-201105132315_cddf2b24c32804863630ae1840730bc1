package com.sulake.habbo.ui.handler
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetLetUserInMessage.const_830];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_830:
      ...
      {
         return [RoomSessionDoorbellEvent.const_128,RoomSessionDoorbellEvent.const_150,RoomSessionDoorbellEvent.const_61];
      }
