package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_720,RoomWidgetViralFurniMessage.const_878,RoomWidgetViralFurniMessage.const_184];
      }
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_636,RoomSessionViralFurniStatusEvent.const_474];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_636:
               ...
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_914);
