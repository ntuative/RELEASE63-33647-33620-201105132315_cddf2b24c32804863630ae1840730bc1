         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_731:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getNumber(RoomObjectVariableEnum.const_264);
                     ...
                     _loc10_ = new RoomWidgetTrophyDataUpdateEvent(RoomWidgetTrophyDataUpdateEvent.const_778,_loc5_,_loc7_,_loc8_,_loc9_);
