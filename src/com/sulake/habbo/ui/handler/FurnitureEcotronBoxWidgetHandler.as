package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_692,RoomWidgetEcotronBoxOpenMessage.const_863,RoomWidgetEcotronBoxOpenedMessage.const_1761];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_692:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_863:
