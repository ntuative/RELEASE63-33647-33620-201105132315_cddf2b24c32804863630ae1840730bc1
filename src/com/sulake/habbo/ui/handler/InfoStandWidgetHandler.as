package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_230.events.addEventListener(NowPlayingEvent.const_99,this.onNowPlayingChanged);
            this.var_230.events.addEventListener(SongInfoReceivedEvent.const_95,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_108,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_108,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_230 != null)
         {
            this.var_230.events.removeEventListener(NowPlayingEvent.const_99,this.onNowPlayingChanged);
            this.var_230.events.removeEventListener(SongInfoReceivedEvent.const_95,this.onSongInfoReceivedEvent);
            this.var_230 = null;
         }
         this.var_1085 = true;
         this.container = null;
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomObjectMessage.const_910);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_980);
         _loc1_.push(RoomWidgetFurniActionMessage.const_258);
         _loc1_.push(RoomWidgetFurniActionMessage.const_716);
         _loc1_.push(RoomWidgetFurniActionMessage.const_683);
         _loc1_.push(RoomWidgetFurniActionMessage.const_743);
         _loc1_.push(RoomWidgetFurniActionMessage.const_918);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_893);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_697);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_938);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1796);
         _loc1_.push(RoomWidgetPetCommandMessage.const_632);
         _loc1_.push(RoomWidgetPetCommandMessage.const_745);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_508)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_375 || param1.type == RoomWidgetUserActionMessage.const_525 || param1.type == RoomWidgetUserActionMessage.const_595)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectMessage.const_910:
            ...
            case RoomWidgetUserActionMessage.const_527:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1153,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_556:
               ...
               break;
            case RoomWidgetUserActionMessage.const_980:
            ...
            case RoomWidgetUserActionMessage.const_595:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_716:
            ...
            case RoomWidgetFurniActionMessage.const_258:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_683:
            ...
            case RoomWidgetFurniActionMessage.const_743:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_918:
            ...
            case RoomWidgetUserActionMessage.const_375:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_893:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_697:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_938:
            ...
            case RoomWidgetUserActionMessage.const_565:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_745:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_310);
               _loc6_.id = param1.id;
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1334);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1185);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_577)
                  {
                     _loc30_ = this.var_230.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_382) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_382.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_230.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_141)
               {
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_551);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_132)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_152)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_712);
                  ...
                  _loc35_ = this._container.roomSession.method_2;
                  _loc14_.canTrade = _loc34_ && _loc35_;
                  _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.TRADE_REASON_OK;
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_945;
                  }
                  if(!_loc35_)
                  {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1612);
               }
               else
               {
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_230 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_230.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
