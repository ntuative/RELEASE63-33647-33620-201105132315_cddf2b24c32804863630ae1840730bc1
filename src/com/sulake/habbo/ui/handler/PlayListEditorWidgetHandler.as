package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1670:IMessageEvent;
      
      private var var_1669:IMessageEvent;
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         this.var_1670 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1669 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1388);
         this._connection.addMessageEvent(this.var_1670);
         this._connection.addMessageEvent(this.var_1669);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               ...
               this._connection.removeMessageEvent(this.var_1670);
               this._connection.removeMessageEvent(this.var_1669);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_870,RoomWidgetPlayListModificationMessage.const_803,RoomWidgetPlayListModificationMessage.const_808,RoomWidgetPlayListPlayStateMessage.const_952,RoomWidgetPlayListUserActionMessage.const_869];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_870:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_967,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_803:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_808:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_952:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_869:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_246);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_246:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_762,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_944,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_915));
               break;
