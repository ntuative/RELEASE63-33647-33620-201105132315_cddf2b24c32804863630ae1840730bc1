package com.sulake.habbo.ui
{
   ...
   import com.sulake.habbo.ui.handler.IRoomWidgetHandler;
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private static const const_1362:int = 1000;
      ...
      private var var_912:IHabboModeration;
      ...
      private var var_346:DesktopLayoutManager;
      ...
      private var var_2243:uint = 16777215;
      ...
      private var var_1676:Rectangle;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_346 = new DesktopLayoutManager();
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(this._friendList)
         {
            ...
            this._friendList.events.addEventListener(FriendRequestEvent.const_309,this.processEvent);
         }
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_576,this.onRoomContentLoaded);
      ...
      {
         this.var_346.setLayout(param1,this._windowManager,this._config);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_723.length)
            {
               _loc6_ = this.var_723.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._friendList && this._friendList.events)
         {
            ...
            this._friendList.events.removeEventListener(FriendRequestEvent.const_309,this.processEvent);
         }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_576,this.onRoomContentLoaded);
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_31 != null)
         {
            this._pendingResources = this._roomEngine.loadRoomResources(this.var_31.roomResources);
         ...
         if(this.var_302 != null && this.var_31.state == RoomSessionEvent.const_233)
         {
            this.var_1675 = !this.var_302.showInterstitial();
         }
      ...
      private function onRoomContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         var _loc2_:int = this._pendingResources.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this._pendingResources.splice(_loc2_,1);
         }
         if(this._pendingResources.length == 0)
         {
            this.var_1674 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         this.var_346.addWidgetWindow(param1,_loc2_.mainWindow);
         ...
         if(_loc4_ != null)
         {
            ...
            if(!this.var_723.add(param1,_loc4_))
            {
               _loc4_.dispose();
            }
            _loc8_ = null;
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc8_ = this.var_724.getValue(_loc11_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_724.add(_loc11_,_loc8_);
                  }
                  else
                  {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc8_ = this.var_722.getValue(_loc12_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_722.add(_loc12_,_loc8_);
                  }
                  _loc8_.push(_loc4_);
               }
            }
         ...
         {
            param1 = "null";
            _loc13_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_346.roomViewRect);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_724.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_loc4_.getNumber(RoomObjectVariableEnum.const_1226) == 1)
               {
                  _loc2_ = true;
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_941:
               if(!this.isFurnitureSelectionDisabled(param1))
               {
                  _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_892,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               }
               if(this.var_912 != null && _loc3_ == RoomObjectCategoryEnum.const_33)
               {
                  _loc7_ = this.var_31.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_141)
                  {
                     this.var_912.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_397:
               ...
               break;
            case RoomEngineObjectEvent.const_982:
               switch(_loc3_)
               {
                  case RoomObjectCategoryEnum.const_27:
                  case RoomObjectCategoryEnum.const_26:
            ...
            case RoomEngineObjectEvent.const_170:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_901,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            ...
            case RoomEngineObjectEvent.const_168:
               ...
               this.processWidgetMessage(_loc5_);
               break;
            case RoomEngineSoundMachineEvent.const_246:
               this.processEvent(param1);
         }
         if(_loc4_ != null)
         {
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineEvent.const_582:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_401,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_346.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_718);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_933);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_862);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_165,this.canvasMouseHandler);
         ...
         this.var_346.addRoomView(_loc9_);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2243);
      ...
      {
         var _loc3_:IWindowContainer = this.var_346.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_346.roomViewRect;
      }
      ...
      public function canvasMouseHandler(param1:WindowEvent) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_165:
               _loc3_ = "null";
               break;
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_1676 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_31.roomId,this.var_31.roomCategory,this.var_294[0],_loc2_.width,_loc2_.height);
         if(this.var_494 == null)
         {
            this.var_494 = new Timer(const_1362,1);
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_1676));
      }
      ...
      {
         if(this.var_16 != null && this.var_31 != null && this.var_1675 && this.var_1674)
         {
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_480:
               ...
               this.var_221 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_442,WindowStyle.const_133,WindowParam.const_102) as IToolTipWindow;
