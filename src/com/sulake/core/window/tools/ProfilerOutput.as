package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1372:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1371:Class = ProfilerOutput_profiler_task_xml;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         var _loc4_:ByteArray = new var_1372() as ByteArray;
      ...
      {
         var _loc2_:ByteArray = new var_1371() as ByteArray;
