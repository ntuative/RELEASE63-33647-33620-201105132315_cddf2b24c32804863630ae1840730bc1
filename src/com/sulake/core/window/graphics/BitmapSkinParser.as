package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "RoomWidgetStopEffectMessage";
      ...
      protected static function method_9(param1:XML, param2:Map) : SkinLayoutEntity
      {
         var _loc3_:* = 0;
         var _loc4_:* = null;
         var _loc5_:* = null;
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "RoomWidgetStopEffectMessage";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_333 = SkinLayoutEntity.const_621;
                  break;
               case "move":
                  _loc5_.var_333 = SkinLayoutEntity.const_303;
                  break;
               case "strech":
                  _loc5_.var_333 = SkinLayoutEntity.const_618;
                  break;
               case "tiled":
                  _loc5_.var_333 = SkinLayoutEntity.const_344;
                  break;
               case "center":
                  _loc5_.var_333 = SkinLayoutEntity.const_511;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_334 = SkinLayoutEntity.const_621;
                  break;
               case "move":
                  _loc5_.var_334 = SkinLayoutEntity.const_303;
                  break;
               case "strech":
                  _loc5_.var_334 = SkinLayoutEntity.const_618;
                  break;
               case "tiled":
                  _loc5_.var_334 = SkinLayoutEntity.const_344;
                  break;
               case "center":
                  _loc5_.var_334 = SkinLayoutEntity.const_511;
            }
         }
      ...
      protected static function parseLayoutEntityList(param1:ISkinRenderer, param2:SkinLayout, param3:XMLList, param4:Map) : void
      {
         ...
         while(_loc6_ < _loc7_)
         {
            _loc5_ = method_9(param3[_loc6_],param4);
            if(_loc5_ != null)
            {
