package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1646:uint = 0;
      
      public static const const_989:uint = 1;
      
      public static const const_1111:uint = 2;
      
      public static const const_782:uint = 4;
      
      public static const const_1688:uint = 8;
      
      public static const const_1728:uint = 16;
      
      public static const const_2129:uint = 64;
      
      public static const const_2022:uint = 128;
      
      public static const const_1338:uint = 256;
         ...
         if(this.var_871)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2139,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2139,16777215);
                  }
                  var_339 += bitmap.width * bitmap.height * 4;
               }
