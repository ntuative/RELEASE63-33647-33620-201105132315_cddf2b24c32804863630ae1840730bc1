package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1094:uint = 8;
      
      private static const const_1586:String = "skin";
      
      private static const const_1582:String = "bitmap";
      
      private static const const_1585:String = "fill";
      
      private static const const_1583:String = "text";
      
      private static const const_1581:String = "label";
      
      private static const const_1584:String = "shape";
      ...
      private var var_2860:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2860 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2059,this.var_2860);
         this.var_2859 = new Dictionary();
         this.var_2858 = new Dictionary();
         StateCodeTable.fillTables(this.var_2859,this.var_2858);
         this.var_472 = new Dictionary();
         this.var_472[const_1586] = BitmapSkinRenderer;
         this.var_472[const_1582] = BitmapDataRenderer;
         this.var_472[const_1585] = FillSkinRenderer;
         this.var_472[const_1583] = TextSkinRenderer;
         this.var_472[const_1581] = LabelRenderer;
         this.var_472[const_1584] = ShapeSkinRenderer;
         ...
         if(var_341 == null)
         {
            ...
            var_341.push(WindowState.const_92);
            var_341.push(WindowState.const_56);
            var_341.push(WindowState.const_87);
            var_341.push(WindowState.const_88);
            var_341.push(WindowState.const_84);
            var_341.push(WindowState.const_100);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2907 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "RoomWidgetStopEffectMessage" : false;
                  ...
                  this.addSkinRenderer(this.var_2059[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1064[param1] == null)
         {
            this.var_1064[param1] = new Array(const_1094);
         }
         this.var_1064[param1][param2] = param3;
         if(this.var_1065[param1] == null)
         {
            this.var_1065[param1] = new Array(const_1094);
         }
         this.var_1065[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1064[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1065[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_133)
