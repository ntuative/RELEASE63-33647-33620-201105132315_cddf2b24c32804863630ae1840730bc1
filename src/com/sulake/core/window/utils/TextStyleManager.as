package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_655:String = "}";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_88[const_212],var_88[ITALIC],var_88[BOLD]];
            var_88.reset();
            var_88[const_212] = _loc5_[0];
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "RoomWidgetStopEffectMessage" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_655);
         if(countSubStrings(param1,const_656) != countSubStrings(param1,const_655))
         {
            throw new Error("Mismatching amount of \"" + const_656 + "\" versus \"" + const_655 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            ...
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_656)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
