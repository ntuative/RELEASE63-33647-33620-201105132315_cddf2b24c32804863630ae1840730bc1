package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private var var_1804:StyleSheet = null;
      ...
      {
         this.var_761 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      {
         if(PropertyDefaults.const_695.indexOf(param1) > -1)
         {
            this.var_761 = param1;
         }
      }
      ...
      {
         return this.var_761 == LinkTarget.const_30 ? defaultLinkTarget : this.var_761;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1804;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_761 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_798,this.var_761,PropertyStruct.const_53,true,PropertyDefaults.const_695));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_761 = _loc2_.value as String;
               break;
            }
