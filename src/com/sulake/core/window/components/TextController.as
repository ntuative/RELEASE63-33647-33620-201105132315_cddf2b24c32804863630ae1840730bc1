package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_972 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_878 * this.maxScrollH,this.var_570 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_709,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1219));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1294 ? new PropertyStruct(PropertyDefaults.const_706,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1157) : PropertyDefaults.const_1883);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_235,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1280 ? new PropertyStruct(PropertyDefaults.const_1164,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1335) : PropertyDefaults.const_1803);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_947) ? new PropertyStruct(PropertyDefaults.const_396,this._field.textColor,PropertyStruct.const_138,true) : PropertyDefaults.const_1202);
         _loc1_.push(this.var_453 != TextStyleManager.const_212 ? new PropertyStruct(PropertyDefaults.const_426,this.var_453,PropertyStruct.const_53,true,PropertyDefaults.const_722) : PropertyDefaults.const_1197);
         _loc1_.push(this.var_41.left != PropertyDefaults.const_911 ? new PropertyStruct(PropertyDefaults.const_241,this.var_41.left,PropertyStruct.const_41,true) : PropertyDefaults.const_717);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_845 ? new PropertyStruct(PropertyDefaults.const_234,this.var_41.top,PropertyStruct.const_41,true) : PropertyDefaults.const_857);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_956 ? new PropertyStruct(PropertyDefaults.const_290,this.var_41.right,PropertyStruct.const_41,true) : PropertyDefaults.const_979);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_729 ? new PropertyStruct(PropertyDefaults.const_283,this.var_41.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_713);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1313 ? new PropertyStruct(PropertyDefaults.const_848,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1838);
