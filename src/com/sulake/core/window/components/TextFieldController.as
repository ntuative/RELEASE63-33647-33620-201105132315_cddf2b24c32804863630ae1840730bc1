package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1625:uint = 500;
      
      protected var var_1352:String = "";
      
      protected var var_1348:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1111,var_11);
         }
         return var_22;
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_315,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_977,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1875);
         _loc1_.push(this.var_1348 != PropertyDefaults.const_1167 ? new PropertyStruct(PropertyDefaults.const_839,this.var_1348,PropertyStruct.const_38,true) : PropertyDefaults.const_1794);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1174 ? new PropertyStruct(PropertyDefaults.const_877,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1821);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1182 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1860);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_839:
                  this.var_1348 = _loc2_.value as Boolean;
                  if(this.var_1348)
                  {
               ...
               case PropertyDefaults.const_977:
                  ...
                  break;
               case PropertyDefaults.const_1187:
