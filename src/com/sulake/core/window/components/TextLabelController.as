package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_382:Object = null;
      ...
      protected function get textField() : TextField
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _loc1_.textColor = uint(this.var_382);
            }
         }
         return _loc1_;
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2715 = _loc2_.textWidth;
         this.var_2716 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_382 != _loc2_.color : this.var_382 != null && this.var_382 != PropertyDefaults.const_947) ? new PropertyStruct(PropertyDefaults.const_396,this.var_382,PropertyStruct.const_138,true) : PropertyDefaults.const_1202);
         if(this.var_41)
         {
            if(this.var_41.left != PropertyDefaults.const_911)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_241,this.var_41.left,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_717);
            }
            if(this.var_41.top != PropertyDefaults.const_845)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_234,this.var_41.top,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_857);
            }
            if(this.var_41.right != PropertyDefaults.const_956)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_290,this.var_41.right,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_979);
            }
            if(this.var_41.bottom != PropertyDefaults.const_729)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_283,this.var_41.bottom,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_713);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_396:
                  this.var_382 = _loc2_.value as uint;
                  break;
