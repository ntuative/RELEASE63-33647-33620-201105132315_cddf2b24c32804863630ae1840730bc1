package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1446:String = "_SELECTOR";
      
      private static const const_1447:String = "_CONTENT";
       
      
      protected var var_1086:ITabSelectorWindow;
      
      protected var var_2140:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1086 = findChildByTag(const_1446) as ITabSelectorWindow;
            if(this.var_1086 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2140 = findChildByTag(const_1447) as IWindowContainer;
         }
