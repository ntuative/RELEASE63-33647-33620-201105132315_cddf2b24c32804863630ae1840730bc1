package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_422)
         {
            this.var_422.removeEventListener(WindowEvent.const_279,this.scrollBarEventProc);
            this.var_422.removeEventListener(WindowEvent.const_277,this.scrollBarEventProc);
            this.var_422 = null;
         }
         if(this.var_1136)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_422)
         {
            ...
            if(this.var_422)
            {
               this.var_422.addEventListener(WindowEvent.const_279,this.scrollBarEventProc);
               this.var_422.addEventListener(WindowEvent.const_277,this.scrollBarEventProc);
            }
         }
         return this.var_422;
      }
