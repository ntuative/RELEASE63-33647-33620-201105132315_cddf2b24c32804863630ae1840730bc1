package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1625 = PropertyDefaults.const_783;
         this.var_1352 = PropertyDefaults.const_429;
         param4 |= 0;
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_429)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_429)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_840,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1716);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_783)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_689,param1.toolTipDelay,PropertyStruct.const_235,true));
         }
         else
         {
