package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_1971:String = "_POINTER_UP";
      
      private static const const_1972:String = "_POINTER_DOWN";
      
      private static const const_1970:String = "_POINTER_LEFT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_904,this._direction,PropertyStruct.const_53,true));
         }
         else
         {
