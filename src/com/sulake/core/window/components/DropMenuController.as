package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_266.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_327,this,null,true);
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_189 == null || this.var_189.disposed)
         {
            this.var_189 = context.create(name + "::submenu","",WindowType.const_524,var_81,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_266.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_995 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_995)
         {
            if(this.open())
            {
               if(this.var_266.length)
               {
                  this.populateMenuItemContainer(this.var_266,this.getSubMenu(),this.subMenuEventProc);
                  this.var_995 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_995 = false;
            this.getTitleLabel().text = this.var_642 < this.var_266.length && this.var_642 > -1 ? this.var_266[this.var_642] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_503,var_81,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_427,var_81,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         {
            _loc4_.getListItemAt(this.var_642).setStateFlag(WindowState.const_56,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_740)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1178:
      ...
      public function open() : Boolean
      {
         ...
         _loc1_.recycle();
         visible = true;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1643,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_266[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_266.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_744,this.var_266,PropertyStruct.const_149,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_744)
            {
