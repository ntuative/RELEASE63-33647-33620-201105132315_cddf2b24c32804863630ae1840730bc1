package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1387:String = "error_cat";
      
      private static const const_1385:String = "error_desc";
       
      
      private var var_352:LibraryLoaderQueue;
      
      private var var_744:IEventDispatcher;
      
      private var var_498:uint;
      
      private var var_353:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1139:
               ...
               this.var_353 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_730:
               debug("Core; using complex frame update handler");
               this.var_353 = this.complexFrameUpdateHandler;
               break;
            case Core.const_836:
               debug("Core; using profiler frame update handler");
               this.var_353 = this.profilerFrameUpdateHandler;
               this.var_202 = new Profiler(this);
               attachComponent(this.var_202,[new IIDProfiler()]);
               var_406.addChild(new ProfilerViewer(this.var_202));
               break;
            case Core.const_549:
               debug("Core; using experimental frame update handler");
               this.var_353 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_353 = this.debugFrameUpdateHandler;
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_248[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         ...
         ErrorReportStorage.setParameter(const_1387,String(param3));
         ErrorReportStorage.setParameter(const_1385,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_744 = loadingEventDelegate;
         if(this.var_352 == null)
         {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_305,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_305,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_305,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1782);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_744)
         {
            this.var_744.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_744)
         {
            ...
            this.var_744.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_744)
                  {
                     this.var_744.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_498 - this.var_352.length,this.var_498,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_202 ? 0 : this.var_1405 & 0;
         if(_loc3_ == Core.const_549)
         {
            this.var_248[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_248[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_202 ? 0 : this.var_1405 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_104)
         {
            _loc3_ = this.var_248[_loc5_] as Array;
            if(_loc4_ == Core.const_549)
            {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_353(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_104)
         {
            ...
            receivers = this.var_248[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
