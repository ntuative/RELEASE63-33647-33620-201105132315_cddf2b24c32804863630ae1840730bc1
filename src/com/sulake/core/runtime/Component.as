package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_2162:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1295:uint = 4;
       
      
      protected var var_746:uint = 0;
      ...
      private var var_524:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_524 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_524.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_524.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(this.var_1405 & const_1295)
         {
            if(_loc3_ == 0)
            {
               if(this.var_524.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_746 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_524.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_524.getStructByIndex(_loc8_);
