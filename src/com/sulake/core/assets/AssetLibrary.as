package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1317:String = "AssetLibraryReady";
      ...
      private static var var_1851:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_972 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_626 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1033);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_626 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_626 == param1.url && this.var_969)
         {
            if(!this.var_971 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_627);
            }
            this.var_971 = param2;
      ...
      {
         var _loc2_:Class = this.var_972[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1299,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1265,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_432;
                     this.var_433.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_433.length ? this.getAssetByName(this.var_433[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_163)
         {
            ...
            {
               return this.var_433.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_163[param1] != null || (this.var_627 != null ? this.var_627[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1851.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_163)
            {
               if(this.var_163[_loc2_] == param1)
               {
                  this.var_433.splice(this.var_433.indexOf(_loc2_),1);
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_627 = _loc2_.resource;
         this.var_626 = _loc2_.url;
         if(this.var_971)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_627);
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1033);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_453).toString() == param1)
               {
                  ...
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_626 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_627[param1]);
