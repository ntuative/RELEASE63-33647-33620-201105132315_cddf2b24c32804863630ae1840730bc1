package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1088:LoaderContext;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1088 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_480 = new AssetLibrary("lib-" + this.var_576++);
         this.var_30.push(this.var_480);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1088;
         }
      ...
      {
         return this.var_480.loadFromResource(param1,param2);
      }
      ...
      {
         return this.var_480.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_480.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_480.createAsset(param1,param2);
      }
      ...
      {
         return this.var_480.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_480.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_480.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_30.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_480.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_30.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
