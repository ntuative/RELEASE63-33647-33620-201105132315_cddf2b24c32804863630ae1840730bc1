package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1088 = new LoaderContext();
         this.var_1088.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1088);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_337 = 0;
         this.var_43.load(param1,this.var_1088);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_337 < var_2909)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1087 + (this.var_1087.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_337),this.var_1088);
               return true;
            }
         }
         return false;
