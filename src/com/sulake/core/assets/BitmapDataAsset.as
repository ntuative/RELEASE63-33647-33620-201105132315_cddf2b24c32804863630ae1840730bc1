package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_566:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_566 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_109 is BitmapDataAsset)
         {
            ...
            this.var_1451 = BitmapDataAsset(this.var_109).var_1451;
            this.var_1450 = BitmapDataAsset(this.var_109).var_1450;
            if(this._bitmap != null)
            {
               this.var_109 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1451 = _loc4_ == "1" || _loc4_ == "RoomWidgetStopEffectMessage";
                  break;
               case "flipV":
                  this.var_1450 = _loc4_ == "1" || _loc4_ == "RoomWidgetStopEffectMessage";
                  break;
            }
            _loc2_++;
         }
