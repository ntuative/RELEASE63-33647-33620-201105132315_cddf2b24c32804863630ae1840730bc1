package com.sulake.core.utils.profiler
{
   ...
   public class ProfilerViewer extends TextField implements IDisposable
   {
      ...
      public function ProfilerViewer(param1:IProfiler)
      {
         ...
         {
            this.var_202 = param1;
            this.var_202.addStopEventListener(this.refresh);
         }
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_202)
            {
               this.var_202.removeStopEventListener(this.refresh);
               this.var_202 = null;
            }
            this._disposed = true;
         }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:Array = this.var_202.getProfilerAgentsInArray();
