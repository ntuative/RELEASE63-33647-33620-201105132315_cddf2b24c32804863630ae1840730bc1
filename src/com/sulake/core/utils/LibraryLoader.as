package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1925:uint = 1;
      
      protected static const const_1923:uint = 2;
      
      protected static const const_1922:uint = 4;
      
      protected static const const_1924:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1698:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1210:Boolean = false;
      
      public static const const_1752:int = 2;
      
      private static var var_1068:Array = new Array();
      
      private static var var_855:Array = new Array();
      ...
      protected var var_1356:int;
      
      protected var var_1357:int;
      
      protected var var_2995:uint = 0;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1210)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_855[_loc2_] as LibraryLoader;
            ...
            while(var_855.length < const_1752 && false)
            {
               _loc1_ = var_1068.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1095 ? uint(this.var_1356 - this.var_2145) : uint(getTimer() - this.var_2145);
      }
      ...
      {
         if(!this.var_1095 && !_disposed && this.var_1357 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_241,const_1698 - this.var_1357);
            if(this.var_2927)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_484 == LibraryLoader.const_1924)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_627 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_627.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
