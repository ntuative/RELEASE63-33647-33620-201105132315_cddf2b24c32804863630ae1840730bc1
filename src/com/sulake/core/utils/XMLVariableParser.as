package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_235:String = "uint";
      
      public static const const_117:String = "Number";
      
      public static const const_1706:String = "float";
      
      public static const const_38:String = "Boolean";
      
      public static const const_1763:String = "bool";
      
      public static const const_53:String = "String";
      
      public static const const_280:String = "Point";
      ...
      private static const const_641:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_640:String = "value";
      
      private static const const_664:String = "RoomWidgetStopEffectMessage";
      
      private static const const_1926:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_641);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_641));
         }
         else
         {
            _loc4_ = param1.child(const_641)[0];
         }
         ...
         _loc7_ = param1.attribute(const_640);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_640));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_640)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_253 || _loc5_ == const_149)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_138:
               return uint(param1);
            case const_149:
               return param1.split(const_1345);
            default:
