package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_1013 = param1 * 1024 * 1024;
         this.var_1932 = param2 * 1024 * 1024;
      ...
      {
         this.var_1013 += this.var_1527;
         if(this.var_1013 > this.var_1932)
         {
            this.var_1013 = this.var_1932;
         }
      }
