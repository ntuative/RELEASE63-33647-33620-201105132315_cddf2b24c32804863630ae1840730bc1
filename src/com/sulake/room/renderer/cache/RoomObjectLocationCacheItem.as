package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1666 || param1.getUpdateID() != this.var_2563)
         {
            this.var_2563 = param1.getUpdateID();
            if(param2.updateId != this.var_1666 || _loc4_.x != this.var_1208.x || _loc4_.y != this.var_1208.y || _loc4_.z != this.var_1208.z)
            {
               this.var_1666 = param2.updateId;
               this.var_1208.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2562 = _loc3_;
         if(_loc3_)
         {
