package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_164:IRoomManagerListener;
      
      private var var_2989:IRoomContentLoader;
      
      private var var_631:IRoomObjectFactory = null;
      
      private var var_522:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1209:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_576,this.onContentLoaded);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_631 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_631 == null || this.var_522 == null)
         {
            return;
         }
         this._state = const_1669;
         if(this.var_1209 != null)
         {
            _loc1_ = this.var_1209;
            this.var_1209 = null;
            this.initialize(_loc1_,this.var_164);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_630.indexOf(_loc5_) < 0)
            {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_609.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_609.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_609[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_631.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_631 != null)
         {
            return this.var_631.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_55.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_630.indexOf(param1);
            if(_loc2_ >= 0)
            {
            ...
            {
               this._state = const_772;
               if(this.var_164 != null)
               {
                  this.var_164.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_849;
            this.var_164.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_164 != null)
            {
               this.var_164.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_977.indexOf(_loc2_) < 0)
         {
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_977.length > 0)
         {
            _loc2_ = this.var_977[0];
            this.var_977.splice(0,1);
            _loc3_ = this.var_55.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_164 != null)
               {
                  this.var_164.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_164 != null)
            {
               this.var_164.contentLoaded(_loc2_,true);
            }
            if(this.var_630.length > 0)
            {
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_631.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_164 != null)
                              {
                                 this.var_164.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
