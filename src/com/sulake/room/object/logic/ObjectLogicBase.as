package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_371:IRoomObjectController;
      ...
      public function set object(param1:IRoomObjectController) : void
      {
         ...
         {
            this.var_371.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_371 = param1;
            this.var_371.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_371 != null)
            {
               this.var_371.setLocation(param1.loc);
               this.var_371.setDirection(param1.dir);
            }
         }
      }
