package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_2082 = param1.invDigit();
         this.var_2083 = this.var_2082 & 32767;
         this.var_2886 = this.var_2082 >> 15;
         this.var_2887 = 131071;
         this.var_2888 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_178) > 0)
         {
