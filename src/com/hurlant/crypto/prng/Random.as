package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = this.var_117++;
         this.var_159[_loc2_] ^= param1 & 255;
         var _loc3_:* = this.var_117++;
         this.var_159[_loc3_] ^= param1 >> 8 & 255;
         var _loc4_:*;
         this.var_159[_loc4_ = this.var_117++] = this.var_159[_loc4_] ^ param1 >> 16 & 255;
         var _loc5_:*;
         this.var_159[_loc5_ = this.var_117++] = this.var_159[_loc5_] ^ param1 >> 24 & 255;
         this.var_117 %= this.psize;
         this.var_2425 = true;
      }
