package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            Habbo.reportCrash("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",Core.const_305,null);
         }
      }
      ...
      private function setupCoreConfigFromLoader(param1:AssetLoaderStruct) : void
      {
         ...
         {
            Habbo.reportCrash("Download external configuration document is null!",Core.const_305,null);
         }
         if(this.var_24)
         {
         ...
         {
            Habbo.reportCrash("Core vanished while downloading config document!",Core.const_305,null);
         }
      }
